                ...
                <?php if(!empty($userCarts) and count($userCarts) > 0): ?>
                                    ...
                                    <div class="navbar-cart-info">
                                        ...
                                        <div class="price mt-10">
                                            <?php if(!empty($cartItemInfo['discountPrice'])): ?>
                                                <span class="text-primary font-weight-bold"><?php echo e(handlePrice($cartItemInfo['discountPrice'], true, true, false, null, true)); ?></span>
                                                <span class="off ml-15"><?php echo e(handlePrice($cartItemInfo['price'], true, true, false, null, true)); ?></span>
                                            <?php else: ?>
                                                <span class="text-primary font-weight-bold"><?php echo e(handlePrice($cartItemInfo['price'], true, true, false, null, true)); ?></span>
                                            <?php endif; ?>
                    ...
                    <div class="navbar-cart-actions">
                        <div class="navbar-cart-total mt-15 border-top d-flex align-items-center justify-content-between">
                            ...
                            <strong class="text-primary font-weight-bold"><?php echo e(!empty($totalCartsPrice) ? handlePrice($totalCartsPrice, true, true, false, null, true) : 0); ?></strong>
                        </div>
...
<?php /**PATH E:\XAMPP_7.4.2\htdocs\rurera\resources\views/web/default/includes/shopping-cart-dropdwon.blade.php ENDPATH**/ ?>