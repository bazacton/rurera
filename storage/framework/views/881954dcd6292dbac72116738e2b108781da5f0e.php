                                ...
                                <?php $__currentLoopData = $recentComments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recentComment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <span class="text-small text-muted"><?php echo e(nl2br(truncate($recentComment->comment, 150))); ?></span>
                                        </div>
                                    </li>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\XAMPP_7.4.2\htdocs\rurera\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>