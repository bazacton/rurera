...
class AssignmentsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $StudentAssignments = StudentAssignments::create([
            ...
            'target_percentage'          => isset($data['target_percentage']) ? $data['target_percentage'] : '',
            'target_average_time'        => isset($data['target_average_time']) ? $data['target_average_time'] : '',
            'assignment_reviewer'        => isset($data['assignment_reviewer']) ? $data['assignment_reviewer'] : '',
            'assignment_review_due_date' => isset($data['assignment_review_due_date']) ? strtotime($data['assignment_review_due_date']) : '',
            'status'                     => 'active',
            'created_by'                 => $user->id,
            'created_at'                 => time(),
        ]);
