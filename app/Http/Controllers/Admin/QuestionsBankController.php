            ...
            foreach( $rows as $rowArray){
                if( !empty( $rowArray )){
                    foreach( $rowArray as $key => $rowData){
                        ...
                        $new_title = $new_tag.'-'.$new_word.'-'.$spells_type.'-Audio Question';
