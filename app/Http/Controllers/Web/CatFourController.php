...
class CatFourController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = Quiz::with(['quizQuestionsList'])->where('status', Quiz::ACTIVE)->where('quiz_type', 'cat4');
        ...
        $catFourData = $query->paginate(100);
        ...
        if (!empty($catFourData)) {
            ...
            return view('web.default.cat4.index', $data);
        }
