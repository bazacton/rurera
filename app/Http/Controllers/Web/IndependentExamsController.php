...
class IndependentExamsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $summary_type = 'independent_exams';
        ...
        $independentExamsData = $query->paginate(100);
        ...
        if (!empty($independentExamsData)) {
            $data = [
                'pageTitle'                  => 'I ndependent Exams',
                'data'                       => $independentExamsData,
            ...
            return view('web.default.independent_exams.index', $data);
        }
