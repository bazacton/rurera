...
<link rel="stylesheet" href="/assets/default/vendors/swiper/swiper-bundle.min.css">
    ...
    @section('content')
    <section class="lms-call-to-action mb-50 has-bg position-relative">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="cell-card">
                        <div class="cell-body">
                            <div class="row">
                                <div class="col-12 col-lg-2 col-md-2">
                                    <div class="cell-shaps">
                                        <svg class="shap-lg" xmlns="http://www.w3.org/2000/svg" version="1.0" width="103.000000pt" height="103.000000pt" viewBox="0 0 103.000000 103.000000" preserveAspectRatio="xMidYMid meet">

                                            <g transform="translate(0.000000,103.000000) scale(0.100000,-0.100000)" fill="#000000" stroke="none">
                                                <path d="M246 781 c-131 -131 -237 -244 -235 -250 2 -6 116 101 254 239 137 137 243 250 235 250 -8 0 -123 -107 -254 -239z"></path>
                                                <path d="M320 705 c-167 -167 -301 -308 -297 -312 8 -7 617 595 617 609 0 5 -3 8 -8 8 -4 0 -144 -137 -312 -305z"></path>
                                                <path d="M295 968 c-58 -31 -258 -248 -243 -264 2 -2 67 60 143 136 130 131 150 156 100 128z"></path>
                                                <path d="M396 631 c-186 -186 -334 -341 -329 -344 5 -3 161 146 347 332 186 186 334 341 329 344 -5 3 -161 -146 -347 -332z"></path>
                                                <path d="M467 562 c-310 -310 -366 -372 -339 -372 9 0 712 703 712 713 0 27 -63 -31 -373 -341z"></path>
                                                <path d="M542 487 c-193 -193 -352 -355 -352 -360 0 -27 63 31 373 341 310 310 366 372 339 372 -4 0 -166 -159 -360 -353z"></path>
                                                <path d="M616 411 c-186 -186 -334 -341 -329 -344 5 -3 161 146 347 332 186 186 334 341 329 344 -5 3 -161 -146 -347 -332z"></path>
                                                <path d="M690 335 c-167 -167 -301 -308 -297 -312 8 -7 617 595 617 609 0 5 -3 8 -8 8 -4 0 -144 -137 -312 -305z"></path>
                                                <path d="M765 260 c-137 -137 -243 -250 -235 -250 20 0 494 474 489 489 -2 6 -116 -101 -254 -239z"></path>
                                                <path d="M835 190 c-77 -77 -136 -140 -132 -140 45 0 297 253 275 276 -2 2 -67 -60 -143 -136z"></path>
                                            </g>
                                        </svg>
                                        <svg class="shap-sm" xmlns="http://www.w3.org/2000/svg" version="1.0" width="62.000000pt" height="62.000000pt" viewBox="0 0 62.000000 62.000000" preserveAspectRatio="xMidYMid meet">

                                            <g transform="translate(0.000000,62.000000) scale(0.100000,-0.100000)" fill="#000000" stroke="none">
                                                <path d="M244 609 c-98 -22 -198 -115 -224 -207 -31 -112 -2 -221 79 -303 82 -81 191 -110 303 -79 98 28 186 127 209 238 9 45 8 67 -5 119 -29 117 -107 198 -222 228 -64 17 -80 17 -140 4z m186 -49 c61 -30 97 -66 127 -124 128 -252 -165 -513 -398 -354 -193 131 -155 411 68 494 52 20 147 12 203 -16z"></path>
                                                <path d="M225 458 c-47 -27 -85 -94 -85 -149 0 -86 83 -169 169 -169 55 0 122 38 149 85 18 32 22 51 19 98 -6 94 -60 148 -154 154 -47 3 -66 -1 -98 -19z m164 -27 c64 -45 83 -120 47 -189 -49 -94 -187 -97 -247 -6 -33 51 -20 146 25 183 49 41 128 46 175 12z"></path>
                                            </g>
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-lg-2 col-md-2">
                                    <div class="cell-shaps text-right">
                                        <svg class="shap-lg" xmlns="http://www.w3.org/2000/svg" version="1.0" width="103.000000pt" height="103.000000pt" viewBox="0 0 103.000000 103.000000" preserveAspectRatio="xMidYMid meet">
                                        ...
                                        <svg class="shap-sm" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M24 0l-6 22-8.129-7.239 7.802-8.234-10.458 7.227-7.215-1.754 24-12zm-15 16.668v7.332l3.258-4.431-3.258-2.901z"></path></svg>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section class="container mt-0 mt-md-0 pt-30">
        <div class="row">
            <div class="col-12">
                <div class="post-show mt-0">
                    <div class="lms-faqs mt-0">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item"><a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Students</a></li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="services-card text-center mb-30">
                    <div class="services-card-body">
                        <span class="icon-box" style="background-color: var(--secondary);color:#fff;">
                            <svg
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="services-card text-center mb-30">
                    <div class="services-card-body">
                        <span class="icon-box" style="background-color: var(--secondary);">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="services-card text-center mb-30">
                    <div class="services-card-body">
                        <span class="icon-box" style="background-color: var(--secondary);">
                            <svg fill="#fff" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" stroke="#fff">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                                    <path
