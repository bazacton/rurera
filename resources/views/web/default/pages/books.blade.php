        ...
        <div class="row h-100 align-items-center justify-content-center text-center">
            <div class="col-12 col-md-9 col-lg-7">
                <div class="text-holder">
                    <h1 class="font-30 font-weight-bold">NEW</h1>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="swiper-wrapper" style="transform: translate3d(0, 0, 0);">
                        <div class="swiper-slide swiper-slide-active" style="width: 250px;">
                            <div class="img-holder">
                                <figure>
                                    <a href="#"><img src="../assets/default/img/book1.png" alt=""/></a>
                                </figure>
                            </div>
                        </div>
                        <div class="swiper-slide swiper-slide-next" style="width: 250px;">
                            <div class="img-holder">
                                <figure>
                                    <a href="#"><img src="../assets/default/img/book2.png" alt=""/></a>
                                </figure>
                            </div>
                        </div>
                        <div class="swiper-slide" style="width: 250px;">
                            <div class="img-holder">
                                <figure>
                                    <a href="#"><img src="../assets/default/img/book3.png" alt=""/></a>
                                </figure>
                            </div>
                        </div>
                        <div class="swiper-slide" style="width: 250px;">
                            <div class="img-holder">
                                <figure>
                                    <a href="#"><img src="../assets/default/img/book4.png" alt=""/></a>
                                </figure>
                            </div>
                        </div>
                        <div class="swiper-slide" style="width: 250px;">
                ...
                <div class="swiper-button-prev swiper-button-disabled" tabindex="-1" role="button" aria-label="Previous slide" aria-disabled="true"><img
                        src="../assets/default/img/slider-arrow-left.png" alt=""/></div>
                <div class="swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-disabled="false"><img src="../assets/default/img/slider-arrow-right.png" alt=""/></div>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row" style="margin-top: 100px;">
            <div class="col-12 col-lg-6">
                <div class="position-relative left" style="z-index: 3;">
                    <div class="find-instructor-circle gradient-green"><span class="lms-serial-no">#1</span></div>
                    <h2 class="font-30 font-weight-bold text-dark">Reading Progress and Statistics</h2>
            ...
            <div class="col-12 col-lg-6 mt-20 mt-lg-0">
                <div class="position-relative float-right"><img src="../assets/default/img/find-instructor-img1.png" class="find-instructor-section-hero" alt="Find the best instructor"/></div>
            </div>
        </div>
        <div class="row mb-50" style="margin-top: 150px;">
            <div class="col-12 col-lg-6 mt-20 mt-lg-0">
                <div class="position-relative"><img src="../assets/default/img/find-instructor-img1.png" class="find-instructor-section-hero" alt="Find the best instructor"/></div>
            </div>
            <div class="col-12 col-lg-6">
                <div class="position-relative right" style="z-index: 3;">
                    ...
                    <h2 class="font-30 font-weight-bold text-dark">E-Book Formats</h2>
                    <p class="font-16 font-weight-normal text-gray mt-10">
...
<section class="lms-books-listing pb-0 pt-50" style="background-color: #f1f1f1;">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <span class="mb-35 d-block">For kids ages 0-3</span>
                                </div>
                                    ...
                                    <div class="listing-card">
                                        <div class="row">
                                            <div class="col-12 col-lg-2 col-md-3">
                                                <div class="img-holder">
                                                    <figure>
                                                        <a href="#"><img src="{{$bookData->cover_image }}" alt=""/></a>
                                                    </figure>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-lg-6 col-md-5">
                                                <div class="text-holder">
                                                    <h3><a href="/books/{{$bookData->book_slug}}">{{$bookData->book_title}}</a></h3>
                                                    <ul>
                                                        ...
                                                        <li><span>Points :</span>{{$bookData->reading_points }} <img src="../assets/default/img/coin-earn.svg" alt=""/></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-4 col-md-4">
                                                <div class="btn-holder">
                                                    <a href=""/books/{{$bookData->book_slug}}" class="read-btn">
                                                    <span class="btn-icon">
                                                                                            <svg
...
<div class="lms-faqs">
    <h1 class="font-36 font-weight-bold mb-30" style="text-align: center; color: #27325e;">Common Questions</h1>
            ...
            <div id="accordion">
                <div class="card">
                    <div class="card-header" id="heading">
                        <h5 class="mb-0">
                            <button class="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">What are Rurera Collection Edition books?
                            </button>
                        </h5>
                    </div>
                ...
                <div class="card">
                    <div class="card-header" id="headingTwo">
                        <h5 class="mb-0">
                            <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">How do you make sure the books
                                are good?
                            </button>
                        </h5>
                    </div>
                ...
                <div class="card">
                    <div class="card-header" id="headingThree">
                        <h5 class="mb-0">
                            <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">Why not just buy books at the
                                store or on Amazon?
                            </button>
                        </h5>
                    </div>
                ...
                <div class="card">
                    <div class="card-header" id="headingfour">
                        <h5 class="mb-0">
                            <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapsefour" aria-expanded="false" aria-controls="collapsefour">Can l order today but have my
                ...
                <div class="card">
                    <div class="card-header" id="headingfive">
                        <h5 class="mb-0">
                            <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapsefive" aria-expanded="false" aria-controls="collapsefive">Are there any initiation,
                ...
                <div class="card">
                    <div class="card-header" id="headingsix">
                        <h5 class="mb-0">
                            <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapsesix" aria-expanded="false" aria-controls="collapsesix">What if I have too many books?
                            </button>
                        </h5>
                    </div>
                ...
                <div class="card">
                    <div class="card-header" id="heading7">
                        <h5 class="mb-0">
                            <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse7" aria-expanded="false" aria-controls="collapse7">What if I have kids in multiple age
                                ranges?
                            </button>
                        </h5>
                    </div>
        ...
        <div class="col-lg-12">
            <div class="lms-reading-progress pb-0">
                <div class="progress-card">
                    <div class="-icon-holder"><img src="../assets/default/img/progress-icon.png" alt=""/></div>
                    <div class="text-holder">
                        ...
                        <div class="btn-holder">
                            <a href="https://chimpstudio.co.uk/flipbook/" class="progress-btn">
                                <span class="icon-svg">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        xmlns:xlink="http://www.w3.org/1999/xlink"
...
<a href="#" class="scroll-btn" style="display: inline;">
    <div class="round">
