...
<style>
    .home-banner {
        background: url(../assets/default/img/home-banner.jpg) 0 0 /cover no-repeat; 
        min-height: 650px;
    }
    .home-categories-section {
        background: url(assets/default/svgs/bank-note-white-thin.svg) #f27530;
    }
    .choose-sats-section {
    ...
    .lms-newsletter {
        background: url(../assets/default/svgs/diagonal-lines-white.svg) #f6b801;
    }
</style>
@endpush
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="feature-grid text-center mb-40">
                        <figure class="mb-20" class="mb-20">
                            <a href="https://rurera.chimpstudio.co.uk/classes?sort=newest">
                                <img src="../assets/default/img/ks1-year1-feature.jpg" alt="feature image" height="143" width="276">
                            </a>
                        </figure>
                        <h3 class="mb-5 font-19 font-weight-500"><a target="_blank" href="https://rurera.chimpstudio.co.uk/classes?sort=newest" class="text-dark-charcoal">KS1 (Year 1)</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="feature-grid text-center mb-40">
                        ...
                        <h3 class="mb-5 font-19 font-weight-500"><a target="_blank" href="https://rurera.chimpstudio.co.uk/classes?sort=newest" class="text-dark-charcoal">KS1 (Year 2)</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="feature-grid text-center mb-40">
                        ...
                        <h3 class="mb-5 font-19 font-weight-500"><a target="_blank" href="https://rurera.chimpstudio.co.uk/classes?sort=newest" class="text-dark-charcoal">KS2 (Year 3)</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="feature-grid text-center mb-40">
                        ...
                        <h3 class="mb-5 font-19 font-weight-500"><a target="_blank" href="https://rurera.chimpstudio.co.uk/classes?sort=newest" class="text-dark-charcoal">KS2 (Year 4)</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="feature-grid text-center mb-40">
                        ...
                        <h3 class="mb-5 font-19 font-weight-500"><a target="_blank" href="https://rurera.chimpstudio.co.uk/classes?sort=newest" class="text-dark-charcoal">KS2 (Year 5)</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="feature-grid text-center mb-40">
                        ...
                        <h3 class="mb-5 font-19 font-weight-500"><a target="_blank" href="https://rurera.chimpstudio.co.uk/classes?sort=newest" class="text-dark-charcoal">KS2 (Year 6)</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="feature-grid text-center mb-40">
                        <figure class="mb-20">
                            <a href="https://rurera.chimpstudio.co.uk/sats/sats_landing">
                                <img src="../assets/default/img/sats-home-feature.jpg" alt="feature image" height="143" width="276">
                            </a>
                        </figure>
                        <h3 class="mb-5 font-19 font-weight-500"><a target="_blank" href="https://rurera.chimpstudio.co.uk/sats/sats_landing" class="text-dark-charcoal">SATs</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="feature-grid text-center mb-40">
                        <figure class="mb-20">
                            <a href="https://rurera.chimpstudio.co.uk/11-plus">
                                <img src="../assets/default/img/11-plus-home-feature.jpg" alt="feature image" height="143" width="276">
                            </a>
                        </figure>
                        <h3 class="mb-5 font-19 font-weight-500"><a target="_blank" href="https://rurera.chimpstudio.co.uk/11-plus" class="text-dark-charcoal">11+ Exam</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="feature-grid text-center mb-40">
                        <figure class="mb-20">
                            <a href="https://rurera.chimpstudio.co.uk/book-shelf">
                                <img src="../assets/default/img/book-shelf-feature.jpg" alt="feature image" height="143" width="276">
                            </a>
                        </figure>
                        <h3 class="mb-5 font-19 font-weight-500"><a target="_blank" href="https://rurera.chimpstudio.co.uk/book-shelf" class="text-dark-charcoal">Advanced ebook shelf</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="feature-grid text-center mb-40">
                        <figure class="mb-20">
                            <a href="https://rurera.chimpstudio.co.uk/timestables/landing">
                                <img src="../assets/default/img/timetables-feature.jpg" alt="feature image" height="143" width="276">
                            </a>
                        </figure>
                        <h3 class="mb-5 font-19 font-weight-500"><a target="_blank" href="https://rurera.chimpstudio.co.uk/timestables/landing" class="text-dark-charcoal">Timestables Revision </a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="feature-grid text-center mb-40">
                        ...
                        <h3 class="mb-5 font-19 font-weight-500"><a target="_blank" href="https://rurera.chimpstudio.co.uk/national-curriculum" class="text-dark-charcoal">National Curriculum</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="feature-grid text-center mb-40">
                        <figure class="mb-20">
                            <a href="https://rurera.chimpstudio.co.uk/leaderboard">
                                <img src="../assets/default/img/leader-board-feature.jpg" alt="feature image" height="143" width="276">
                            </a>
                        </figure>
                        <h3 class="mb-5 font-19 font-weight-500"><a target="_blank" href="https://rurera.chimpstudio.co.uk/leaderboard" class="text-dark-charcoal">Leaderboard</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="feature-grid text-center mb-40">
                        ...
                        <h3 class="mb-5 font-19 font-weight-500"><a target="_blank" href="https://rurera.chimpstudio.co.uk/register" class="text-dark-charcoal">Performance Monitoring</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="feature-grid text-center mb-40">
                        <figure class="mb-20">
                            <a href="https://rurera.chimpstudio.co.uk/rewards">
                                <img src="../assets/default/img/rewards-features.jpg" alt="feature image" height="143" width="276">
                            </a>
                        </figure>
                        <h3 class="mb-5 font-19 font-weight-500"><a target="_blank" href="https://rurera.chimpstudio.co.uk/rewards" class="text-dark-charcoal">Rewards</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="feature-grid text-center mb-40">
                        ...
                        <h3 class="mb-5 font-19 font-weight-500"><a target="_blank" href="https://rurera.chimpstudio.co.uk/membership" class="text-dark-charcoal">Memberships</a></h3>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-3 col-md-6">
                    <div class="sats-box d-inline-flex border-solid border-transparent bg-white">
                        <img class="mb-15 blue-filter" src="../assets/default/svgs/student-user.svg" alt="Rurera Support image" style="filter: brightness(0) saturate(100%) invert(20%) sepia(28%) saturate(3293%) hue-rotate(225deg) brightness(97%) contrast(96%);"> 
