    ...
    <div class="stats-container mb-50 pb-10 pt-20">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title text-center mb-50">
                        <h2 class="mt-0 mb-10">Job perks</h2>
                ...
                <div class="col-sm-6 col-lg-3 mb-30">
                    <div class="stats-item simple d-flex flex-column align-items-center text-center py-30 px-15 w-100">
                        ...
                        <h4 class="stat-title">Free meals</h4>
                        <p class="stat-desc mt-10">Offering healthy meal for employees</p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3 mb-30">
                    <div class="stats-item simple d-flex flex-column align-items-center text-center py-30 px-15 w-100">
                        ...
                        <h4 class="stat-title">Mental health support</h4>
                        <p class="stat-desc mt-10">Provides counseling services with big changes</p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3 mb-30">
                    <div class="stats-item simple d-flex flex-column align-items-center text-center py-30 px-15 w-100">
                        ...
                        <h4 class="stat-title">Continuing education</h4>
                        <p class="stat-desc mt-10">Provide opportunities to complete studies</p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3 mb-30">
                    <div class="stats-item simple d-flex flex-column align-items-center text-center py-30 px-15 w-100">
                        ...
                        <h4 class="stat-title">Freedom fund to travel</h4>
                        <p class="stat-desc mt-10">Chance to travel and enjoy hotel free credits</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-sm-12 col-md-10 col-lg-10">
                    <div class="section-title text-center mb-50">
                        <h2 class="mb-10">Open Positions</h2>
    ...
    <section class="lms-testimonial-slider pt-80 pb-90">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title text-center mb-50">
                        <h2 class="mt-0 mb-10">Explore our customers’ success stories</h2>
                    </div>
                </div>
                <div class="col-12">
            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="section-title text-center mb-40">
                        <h2 class="mt-0 mb-10">Our impact</h2>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-8 col-lg-8">
                    <div class="section-title text-center mb-40">
                        <h2 class="mt-0">Application Form</h2>
                    </div>
