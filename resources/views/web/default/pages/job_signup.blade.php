                        ...
                        <div class="card">
                            ...
                            <div id="collapse_1" class="collapse" aria-labelledby="heading_1" data-parent="#accordionExample">
                                <div class="card-body">
                                    ...
                                    <p itemprop="description">You will be teaching photography theory and practice in group and private
                                        environment.
                                        Your key
                                    ...
                                    <h3 itemprop="title" class="font-24">Managing</h4>
                                    <ul class="lms-disc-list">
                                    ...
                                    <h3 itemprop="title" class="font-24">Marketing</h4>
                                    <ul class="lms-disc-list">
                                        <li>Manage the day to day running of the school to ensure our high quality of
                                            service
                                            remains
                                    ...
                                    <h3 itemprop="title" class="font-24">Teacher management</h4>
                                    <ul class="lms-disc-list">
                                        <li>Manage the day to day running of the school to ensure our high quality of
                                            service
                                            remains
                                    ...
                                    <h3 itemprop="title" class="font-24">Teaching</h4>
                                    <ul class="lms-disc-list">
                                        <li>Manage the day to day running of the school to ensure our high quality of
                                            service
                                            remains
                                    ...
                                    <h3 itemprop="title" class="font-24">Hours and schedule</h4>
                                    <p itemprop="description">9am to 6pm (12-1 lunch &amp; 3:00 to 3:30pm break)</p>
                                    <h3 itemprop="title" class="font-24">Pay and bonuses</h4>
                                    <p itemprop="description">40,000 â€“ 60,000 baht per month standard salary</p>
                                    <p itemprop="description"><a href="#" class="lms-apply-btn">Apply for this teaching position</a></p>
