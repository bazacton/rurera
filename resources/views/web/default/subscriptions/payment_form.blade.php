...
<div class="payment-options-holder panel-border bg-white rounded-sm p-25 mb-40 mt-30">
    ...
    <div class="book-form-holder">
        ...
        <div class="card-gateway-fields-holder">
            ...
            <div class="row card-gateway-fields conditional-fields mb-10">
                <div class="col-12 col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-12 col-md-12">
                                <ul class="tests-list payment-methods mb-15">
                                    ...
                                    <li data-type="googlepay-gateway" class="process-payment" data-user_id="{{isset($user_id)? $user_id : 0}}" data-subscribed_for="{{isset($subscribed_for)? $subscribed_for : 0}}"><img src="/assets/default/svgs/google-pay.svg" class="google-icon" alt=""> Google Pay</li>
                                </ul>
                            </div>
