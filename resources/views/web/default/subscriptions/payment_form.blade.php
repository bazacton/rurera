...
<div class="selected-plan-data pt-20 mb-30">
    <div class="row">
        ...
        <div class="col-12 col-lg-7 col-md-7">
            <div class="text-box">
            <div class="package-price font-weight-500 mb-20"><strong>{{ addCurrencyToPrice(($packageObj->price*$subscribed_for_months)) }}</strong> / {{$subscribed_for_label}}</div>
        ...
        <div class="book-form mt-30">
            <div class="row">
                ...
                <div class="col-12 col-lg-3 col-md-3 col-sm-12">
                    <a href="javascript:;" class="nav-link btn-primary rounded-pill mb-25 ">Apply</a>
                </div>
            </div>
        </div>
    </div>
