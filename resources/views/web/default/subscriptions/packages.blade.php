...
<section class="lms-setup-progress-section mb-0 pt-20 pb-60">
        <div class="container">
                    ...
                    <div class="row">
                        @if(!empty($subscribes) and !$subscribes->isEmpty())
                            @foreach($subscribes as $subscribe)
                                @php
                                       $without_discount = $subscribe->price*12;
                                       $discount_price = ($subscribe->price*25) / 100;
                                       $yearly_price = ($subscribe->price)-$discount_price;
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="subscribe-plan {{($selected_package == $subscribe->id)? 'active' : ''}} current-plan position-relative d-flex flex-column rounded-lg p-25 mb-30">
                                        ...
                                        <div class="d-flex align-items-start text-dark-charcoal mt-10 subscribe-price">
                                            <span itemprop="price" class="font-36 line-height-1 packages-prices" data-package_price="{{$subscribe->price}}">{{ addCurrencyToPrice($subscribe->price) }}/mo</span><span class="yearly-price">Save ${{$yearly_price}} with a yearly plan</span>
                                        </div>
