...
<style>
    ...
    .chart-box.bars svg line {
        display: none;
    }

    .chart-box.lines g rect,
    .chart-box.lines g text {
        display: none;
    }

    .chart-box.lines g g path {
        stroke: #417290;
    }

    .chart-box.lines g rect ~ path {
        stroke: none;
    }
    ...
    .chart-filters li a.active {
        border-bottom: 2px solid #3e97fb;
        margin-bottom: -4px;
    }
    ...
    .chart-summary-fields .sats-summary .row {
        gap: 15px;
    }

    .chart-summary-fields .sats-summary .col-lg-3 {
        flex: 0 0 24%;
        max-width: 24%;
    }

    .chart-summary-fields .sats-summary [class*="col-"] {
        border: 0;
        border-radius: 3px;
    ...
    .chart-summary-fields .sats-summary .sats-summary-icon {
        margin-right: 8px;
        width: 35px;
        height: 35px;
        text-align: center;
    ...
    .chart-summary-fields .sats-summary .sats-summary-icon img {
        width: 35px;
        height: 35px;
    }

    .chart-summary-fields .sats-summary .sats-summary-icon svg {
        width: 20px;
        height: 20px;
    }

    .chart-summary-fields .sats-summary .summary-text {
        width: calc(100% - 45px);
    }
    ...
    .chart-summary-fields .sats-summary [class*="col-"].bitcoin-box {
        background-color: initial;
        padding-left: 0;
    }

    .chart-summary-fields .sats-summary .score {
        color: #0d173b;
        font-size: 16px;
    }

    .chart-summary-fields .sats-summary [class*="col-"].bg-none {
                        ...
                        <ul class="graph-data-ul">
                            @if( !empty( $graphs_array ) )
                                @foreach( $graphs_array as $graph_key => $graphsData)
                                        ...
                                        <li><a href="javascript:;" class="{{$activeClass}}" data-graph_id="graph_id_{{$graph_key}}">{{$graph_key}}</a></li>
                                @endforeach
                            @endif
                            <li><a href="#">Custom</a></li>
                        </ul>
                    </div>
                    <div class="sats-summary hide">
                        <div class="row">
                        ...
                        <div class="chart">
                            <div class="chart">
                                @if( !empty( $graphs_array ) )
                                    ...
                                    <canvas id="graph_{{$graph_key}}" class="graph_div graph_id_{{$graph_key}} {{$hideClass}}"></canvas>
                                @endforeach
                                @endif
                            </div>
                        </div>
    ...
    $(document).ready(function () {
        ...
        @if( !empty( $graphs_array ) )
                ...
                <script>
                    ...
                    var graph_val = document.getElementById("graph_{{$graph_key}}").getContext("2d");
