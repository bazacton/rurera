...
<script>
    ...
    var SpellQuestionintervalFunc = function() {

        var SpellQuestioninterval = setInterval(function () {
            console.log('SpellQuestioninterval');
    ...
    var SpellQuestionintervalCountDownFunc = function() {
            ...
            var Questioninterval = setInterval(function () {
                console.log('SpellQuestionCountDowninterval');
                ...
                $(".question-time-remaining-{{ $question->id }}").html(':'+seconds_count);
            }, 1000);
        }
