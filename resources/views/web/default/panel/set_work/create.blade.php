                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="users_list_block">
                                                        <ul class="users-list">
                                                            ...
                                                            <li data-user_id="{{$childObj->id}}">
                                                                <span><input type="checkbox" id="select_user{{$childObj->id}}" value="{{$childObj->id}}"
                                                                             name="ajax[{{ !empty($assignment) ? $assignment->id : 'new' }}][assignment_users][]"><label
                                                                            for="select_user{{$childObj->id}}">{{$childObj->full_name}}</label></span>
                                                            </li>
                                                            @endforeach
                                                        </ul>
                                                    </div>
