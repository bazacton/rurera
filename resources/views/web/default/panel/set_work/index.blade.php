                                ...
                                <div class="list-group-item">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto">
                                            ...
                                            <h6 class="font-16 font-weight-normal pl-15">
                                                @if( $assignmentObj->students->count() > 0)
                                                    @foreach($assignmentObj->students as $studentObj)
                                                      <img src="{{$studentObj->user->getAvatar()}}"> {{$studentObj->user->get_full_name()}}
                                                    @endforeach
                                                @endif
                                            </h6>
                                        </div>
                                        <div class="col-auto">
                                            ...
                                            <h6 class="font-16 font-weight-normal">
                                                <img class="quiz-type-icon" src="/assets/default/img/assignment-logo/{{$assignmentObj->assignment_type}}.png">
                                        ...
                                        <div class="col-auto ms-auto last-activity ">
                                            <h6 class="listing-title font-14 font-weight-500">Action</h6>
                                            <a href="/panel/set-work/{{$assignmentObj->id}}/progress" class="">Details</a>
                                        </div>
                                    </div> <!--[ row end ]-->
                                </div>
