                            ...
                            <div class="row">
                                <div class="col-12 col-md-4 col-lg-3 bitcoin-box">
                                                ...
                                                <g id="Group_1262">
                                                    <g id="speedometer" transform="translate(188.102 869.102)">
                                                        ...
                                                        <path id="Path_1548"
                                                              ...
                                                              class="cls-1" transform="translate(-102.104 -305.954)"></path>
                                                        <path id="Path_1549"
                                                              ...
                                                              class="cls-1" transform="translate(-202.104 -114.509)"></path>
                                                        <path id="Path_1550"
                                                              ...
                                                              class="cls-1" transform="translate(-53.376 -53.375)"></path>
                                                    </g>
                                                </g>
                                            </g>
                                        </svg>
                                    ...
                                    <div class="summary-text">
                                        ...
                                        <div class="score">{{$QuizzesResult->quizz_result_questions_list->where('status', '!=', 'waiting')->count()}}</div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-4 col-lg-3">
                                    ...
                                    <div class="summary-text">
                                        ...
                                        <div class="score incorrect-questions">{{$QuizzesResult->quizz_result_questions_list->where('status','incorrect')->count()}}</div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-4 col-lg-3">
                                    <div class="sats-summary-icon" style="background-color: #0272b6;">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#fff" version="1.1" id="Capa_1" width="800px" height="800px"
                                    ...
                                    <div class="summary-text">
                                        ...
                                        <div class="score summary-coins-earned">{{$QuizzesResult->quizz_result_questions_list->where('status','correct')->count()}}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="summary-btns">
                            <a href="/panel/quizzes/{{$QuizzesResult->id}}/check_answers" class="summary-btn">Summary of Attempt</a>
