...
<div class="row justify-content-center">
            ...
            <div class="question-area-block">
                ...
                @endforeach
                @else
                @php $questionArray = rurera_decode($question);


                @endphp
                @include('web.default.panel.questions.question_layout',['question'=> $questions_layout[0], 'question_no' =>
                $question_no, 'prev_question' => $prev_question, 'next_question' => $next_question , 'quizAttempt' =>
                $quizAttempt, 'questionsData' => $question, 'newQuestionResult' => $newQuestionResult, 'quizResultObj' => $newQuizStart
                ])
                @endif
            </div>
