                ...
                <div class="col-lg-12 col-md-12 col-sm-12 mt-10">
                    ...
                    <div class="question-area-block question-summary">
                        ...
                        <div class="mx-auto">
                            ...
                            $time_consumed_class = '';
                            $time_consumed_class = ($time_consumed <= 1)? 'time-fast' : $time_consumed_class;
                            $time_consumed_class = ($time_consumed > 1)? 'time-ok' : $time_consumed_class;
                            $time_consumed_class = ($time_consumed > 2)? 'time-slow' : $time_consumed_class;
                                    ...
                                    <div class="question-step question-step-5834" data-elapsed="0" data-qattempt="860" data-start_time="0" data-qresult="18333" data-quiz_result_id="249">
                                        <div class="lms-radio-lists">
                                            ...
                                            <div class="questions-controls">
                                                   <span class="time-of-answer {{$time_consumed_class}}">{{$time_consumed}}s</span>
                                               </div>
                                            ...
                                            <span class="list-title">{{isset( auth()->user()->id )? auth()->user()->get_full_name() : 'Guest'}} answered:</span>
                                            <ul class="lms-radio-btn-group lms-user-answer-block">
