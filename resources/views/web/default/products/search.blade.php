...
@section('content')
<section class="products-top-header search-top-banner position-relative job-singup-sub-header gallery-sub-header pb-0" style="min-height: 680px;">
    <div class="container h-100">
        <div class="row h-100">
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-6 gallery-frame-section">
                <div class="row">
                    <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                                <div class="gallery-frame">
                                    <figure><img src="/store/1/Shop/2-1.jpg" alt="#"></figure>
                                </div>
                            </div>
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-6 col-lg-12">
                                        <div class="gallery-frame">
                                            <figure><img src="../assets/default/img/blog-img1.jpg" alt="#"></figure>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-6 col-lg-12">
                                        <div class="gallery-frame">
