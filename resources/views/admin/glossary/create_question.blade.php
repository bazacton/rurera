                ...
                <div class="row">   
                    <div class="col-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ old('title') }}" name="question_title" class="form-control @error('title')  is-invalid @enderror" placeholder=""/>
                            @error('title')
                    ...
                    <div class="col-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ old('title') }}" name="question_score" class="form-control @error('title')  is-invalid @enderror" placeholder=""/>
                            @error('title')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-6 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ old('title') }}" name="question_average_time" class="form-control @error('title')  is-invalid @enderror" placeholder=""/>
                            @error('title')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-6 col-md-4">
                        <div class="form-group">
                            ...
                            <textarea class="note-codable summernote" id="question_explanation" name="question_explanation" aria-multiline="true"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-6 col-md-4">
                        <div class="form-group">
                            ...
                            <textarea class="note-codable summernote" id="question_remember" name="question_remember" aria-multiline="true"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-6 col-md-4">
                        <div class="form-group">
                            ...
                            <textarea class="note-codable summernote" id="question_solve" name="question_solve" aria-multiline="true"></textarea>
                        </div>
                    </div>
                </div>
