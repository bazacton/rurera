                                ...
                                <ul class="draggable-lists list-group">
                                    ...
                                    <li class="form-group list-group">
                                        ...
                                        <div class="p-2 border rounded-sm">
                                            ...
                                            <div class="input-group colorpickerinput w-100 mt-1">
                                                                                <input type="text" name="sub_categories[{{ $subCategory->id }}][color]"
                                                                                       class="form-control w-auto flex-grow-1"
                                            ...
                                            <div class="input-group w-100 mt-1">
                                                <textarea name="sub_categories[{{ $subCategory->id }}][menu_data]"
                                                       class="form-control w-auto flex-grow-1" placeholder="Menu Data">{{ $subCategory->menu_data }}</textarea>
                                            </div>
                                            ...
                                            <div class="input-group mt-1">
                                                ...
                                                <input type="text" name="sub_categories[{{ $subCategory->id }}][icon]" id="icon_{{ $subCategory->id }}" class="form-control"
                                                       value="{{ $subCategory->icon }}" placeholder="{{ trans('admin/main.icon') }}"/>
                                            </div>
                                        </div>
                                    </li>
                                    @endforeach
