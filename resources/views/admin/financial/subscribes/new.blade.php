                            ...
                            <form action="/admin/financial/subscribes/{{ !empty($subscribe) ? $subscribe->id.'/update' : 'store' }}" method="Post">
                                ...
                                <div class="form-group custom-switches-stacked">
                                    <label class="custom-switch pl-0">
                                        ...
                                        <input type="checkbox" name="is_courses" id="is_courses" value="1" {{ (!empty($subscribe) and $subscribe->is_courses) ? 'checked="checked"' : '' }} class="custom-switch-input"/>
                                ...
                                <div class="form-group custom-switches-stacked">
                                                                    <label class="custom-switch pl-0">
                                                                        ...
                                                                        <input type="checkbox" name="is_timestables" id="is_timestables" value="1" {{ (!empty($subscribe) and $subscribe->is_timestables) ? 'checked="checked"' : '' }} class="custom-switch-input"/>
                                                                        <span class="custom-switch-indicator"></span>
                                ...
                                <div class="form-group custom-switches-stacked">
                                                                    <label class="custom-switch pl-0">
                                                                        ...
                                                                        <input type="checkbox" name="is_bookshelf" id="is_bookshelf" value="1" {{ (!empty($subscribe) and $subscribe->is_bookshelf) ? 'checked="checked"' : '' }} class="custom-switch-input"/>
                                                                        <span class="custom-switch-indicator"></span>
                                ...
                                <div class="form-group custom-switches-stacked">
                                                                    <label class="custom-switch pl-0">
                                                                        ...
                                                                        <input type="checkbox" name="is_elevenplus" id="is_elevenplus" value="1" {{ (!empty($subscribe) and $subscribe->is_elevenplus) ? 'checked="checked"' : '' }} class="custom-switch-input"/>
                                                                        <span class="custom-switch-indicator"></span>
