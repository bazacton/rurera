...
<div style="{{$pageInfoLink->info_style}}" data-is_new="no"
     ...
     data-questions_ids="{{isset($data_values->questions_ids)? $data_values->questions_ids : ''}}" data-dependent_info="{{isset($data_values->dependent_info)? $data_values->dependent_info : ''}}" data-no_of_attempts="{{isset($data_values->no_of_attempts)? $data_values->no_of_attempts : ''}}">
