...
<div style="{{$pageInfoLink->info_style}}" data-is_new="no"
     ...
     data-id="{{$pageInfoLink->id}}" data-field_type="think_and_remember"
     data-trigger_class="infobox-think_and_remember-fields" data-infobox_title="{{$pageInfoLink->info_title}}"
     data-infobox_value="{{isset($data_values->infobox_value)? $data_values->infobox_value : ''}}">
    <div class="field-data"><img src="/assets/default/img/book-icons/think_and_remember.png">
    </div>
