...
<section class="section">
    <div class="section-header">
        <h1>{{!empty($glossary) ?trans('/admin/main.edit'): trans('admin/main.new') }} Weekly Planner</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="/admin/">{{ trans('admin/main.dashboard') }}</a>
            </div>
            <div class="breadcrumb-item active"><a href="/admin/weekly_planner">Weekly Planner</a>
            </div>
    ...
    <div class="section-body">
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form action="/admin/weekly_planner/{{ !empty($weeklyPlanner) ? $weeklyPlanner->id.'/store' : 'store' }}"
                              method="Post">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <button class="btn btn-primary add_weekly_planner_set" type="button">Add Set</button>
                            </div>

                            <div class="weekly_planner_sets">
                                                ...
                                                <div class="d-flex align-items-center collapsed"
                                                    ...
                                                    <div class="">
                                                                <span class="font-weight-bold text-dark-blue d-block cursor-pointer"><input
                                                                            name="weekly_planner_title[{{$itemObj->id}}]"
                                                                            type="text" size="50"
                                                                            value="{{$itemObj->title}}"
                                                    ...
                                                    <div class="accordion-content-wrapper mt-15"
                                                        ...
                                                        <ul class="curriculum-item-data-ul draggable-content-lists draggable-lists-chapter-{{$itemObj->id}} ui-sortable"
                                                            ...
                                                            <div class="form-group mt-15 ">
                                                                ...
                                                                <select name="weekly_planner_chapter_topics[{{$itemObj->id}}][week_no]"
                                                            ...
                                                            <div class="form-group mt-15 ">
                                                                ...
                                                                <select name="weekly_planner_chapter_topics[{{$itemObj->id}}][topics][]"
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('body').on('click', '.add_weekly_planner_set', function (e) {
            //$(".weekly_planner_sets").html('');
            $.ajax({
                type: "GET",
                url: '/admin/weekly_planner/weekly_planner_set_layout',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
                data: {},
                success: function (response) {
                    $(".weekly_planner_sets").append(response);
