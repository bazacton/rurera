            ...
            <div class="col-12 col-md-12">
                                        ...
                                        <div class="wrap leform-admin leform-admin-editor">
                                            <div class="leform-form-editor">
                                                <div class="leform-toolbars">
                                                    ...
                                                    <div class="leform-pages-bar">
                                                        <ul class="leform-pages-bar-items hide">
                                                            <li class="leform-pages-bar-item" data-id="1" data-name="Page"><label onclick="return leform_pages_activate(this);">Page</label><span><a href="#" data-type="page" onclick="return leform_properties_open(this);"><i class="fas fa-cog"></i></a><a href="#" class="leform-pages-bar-item-delete leform-pages-bar-item-delete-disabled" onclick="return leform_pages_delete(this);"><i class="fas fa-trash-alt"></i></a></span></li>
                                                        </ul>
                                                    </div>
                                                ...
                                                <div class="leform-builder"><div class="leform-form-global-style"></div>
                                                    <div id="leform-form-1" class="leform-form leform-elements" _data-parent="1" _data-parent-col="0"></div>
                                                </div>
                                            </div>
                                            ...
                                            <form id="leform-import-style-form" enctype="multipart/form-data" method="post" target="leform-import-style-iframe" action="http://baz.com/greenform/?page=leform&leform-action=import-style">
                                            ...
                                            <div class="leform-admin-popup" id="leform-element-properties">
                                                <div class="leform-admin-popup-inner">
                                                    <div class="leform-admin-popup-title">
                                                        <a href="#" title="Close" onclick="return leform_properties_close();"><i class="fas fa-times"></i></a>
                                            ...
                                            <div class="leform-fa-selector">
                                                <div class="leform-fa-selector-inner">
                                                    <div class="leform-fa-selector-header">
                                                        <a href="#" title="Close" onclick="return leform_fa_selector_close();"><i class="fas fa-times"></i></a>
                                                        <input type="text" placeholder="Search...">
                                                    </div>
                                                    <div class="leform-fa-selector-content">
                                                        <span title="No icon" onclick="leform_fa_selector_set(this);"><i class=""></i></span><span title="Star" onclick="leform_fa_selector_set(this);"><i class="leform-fa leform-fa-star"></i></span><span title="Star O" onclick="leform_fa_selector_set(this);"><i class="leform-fa leform-fa-star-o"></i></span><span title="Check" onclick="leform_fa_selector_set(this);"><i class="leform-fa leform-fa-check"></i></span><span title="Close" onclick="leform_fa_selector_set(this);"><i class="leform-fa leform-fa-close"></i></span><span title="Lock" onclick="leform_fa_selector_set(this);"><i class="leform-fa leform-fa-lock"></i></span><span title="Picture O" onclick="leform_fa_selector_set(this);"><i class="leform-fa leform-fa-picture-o"></i></span><span title="Upload" onclick="leform_fa_selector_set(this);"><i class="leform-fa leform-fa-upload"></i></span><span title="Download" onclick="leform_fa_selector_set(this);"><i class="leform-fa leform-fa-download"></i></span><span title="Calendar" onclick="leform_fa_selector_set(this);"><i class="leform-fa leform-fa-calendar"></i></span><span title="Clock O" onclick="leform_fa_selector_set(this);"><i class="leform-fa leform-fa-clock-o"></i></span><span title="Chevron Left" onclick="leform_fa_selector_set(this);"><i class="leform-fa leform-fa-chevron-left"></i></span><span title="Chevron Right" onclick="leform_fa_selector_set(this);"><i class="leform-fa leform-fa-chevron-right"></i></span><span title="Phone" onclick="leform_fa_selector_set(this);"><i class="leform-fa leform-fa-phone"></i></span><span title="Envelope" onclick="leform_fa_selector_set(this);"><i class="leform-fa leform-fa-envelope"></i></span><span title="Envelope O" onclick="leform_fa_selector_set(this);"><i class="leform-fa leform-fa-envelope-o"></i></span><span title="Pencil" onclick="leform_fa_selector_set(this);"><i class="leform-fa leform-fa-pencil"></i></span><span title="Angle Double Left" onclick="leform_fa_selector_set(this);"><i class="leform-fa leform-fa-angle-double-left"></i></span><span title="Angle Double Right" onclick="leform_fa_selector_set(this);"><i class="leform-fa leform-fa-angle-double-right"></i></span><span title="Spinner" onclick="leform_fa_selector_set(this);"><i class="leform-fa leform-fa-spinner"></i></span><span title="Smile O" onclick="leform_fa_selector_set(this);"><i class="leform-fa leform-fa-smile-o"></i></span><span title="Frown O" onclick="leform_fa_selector_set(this);"><i class="leform-fa leform-fa-frown-o"></i></span><span title="Meh O" onclick="leform_fa_selector_set(this);"><i class="leform-fa leform-fa-meh-o"></i></span><span title="Send" onclick="leform_fa_selector_set(this);"><i class="leform-fa leform-fa-send"></i></span><span title="Send O" onclick="leform_fa_selector_set(this);"><i class="leform-fa leform-fa-send-o"></i></span><span title="User" onclick="leform_fa_selector_set(this);"><i class="leform-fa leform-fa-user"></i></span><span title="User O" onclick="leform_fa_selector_set(this);"><i class="leform-fa leform-fa-user-o"></i></span><span title="Building O" onclick="leform_fa_selector_set(this);"><i class="leform-fa leform-fa-building-o"></i></span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="leform-dialog" id="leform-dialog">
                                                <div class="leform-dialog-inner">
                                                    <div class="leform-dialog-title">
                                                        <a href="#" title="Close" onclick="return leform_dialog_close();"><i class="fas fa-times"></i></a>
                                            ...
                                            <script>
                                                ...
                                                var leform_customfonts = [];
                                                        @php echo 'var leform_toolbar_tools = '.json_encode($toolbar_tools); @endphp;
                                                        @php echo 'var leform_meta = '.json_encode($element_properties_meta); @endphp;
                                                ...
                                                var leform_predefined_options = [];
                                                        @php echo 'var leform_form_options = '.$tabs_options; @endphp;
                                                        var leform_form_pages_raw = [{"general": "general", "name": "Page", "id": 1, "type": "page"}];
                                                //var leform_form_elements_raw = []; //Default Value for Questions
                                                @php echo 'var leform_form_elements_raw = '.json_encode($layout_elements); @endphp;
                    ...
                    <div class="col-3 col-md-3">
                        <div class="row">
                            ...
                            @if(auth()->user()->isReviewer())
                                @if($questionObj->question_status == 'Submit for review' || $questionObj->question_status == 'On hold')
                                    <div class="col-12">
                                        <button type="button" data-question_id="{{$questionObj->id}}" class="question-action-btn btn btn-warning">Action</button>
                                    </div>
                                @endif
                            @endif
                            ...
                            <select name="glossary_ids[]" id="glossary_ids" class="glossary-items form-control" multiple>
                                @if(!empty($glossary))
                                    @foreach($glossary as $glossaryData)
                                        ...
                                        @endif
                                    <option value="{{ $glossaryData->id }}" {{$selected}}>{{ $glossaryData->title }}</option>
                                    @endforeach
                                @endif
                            </select>
                ...
                <div class="mt-5 mb-5 create-question-fields-block">
                    @if(auth()->user()->isAuthor() || auth()->user()->isAdmin())
                        ...
                        <button type="button" data-status="Submit for review" class="quiz-stage-generate btn btn-primary">Submit for review</button>
                    @endif

                    @if(auth()->user()->isReviewer())
                        <button type="button" data-status="{{$questionObj->question_status}}" class="quiz-stage-generate btn btn-warning">Update</button>
                    @endif
            ...
            <div class="modal-body">
                <form name="question_status_action_form" id="question_status_action_form">
                    <div class="form-group">
                        ...
                        <select class="form-control @error('category_id') is-invalid @enderror" name="ajax[category_id]">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="ajax[title]" class="form-control  @error('title') is-invalid @enderror" placeholder="{{ trans('admin/main.choose_title') }}"/>
                        @error('title')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="note-codable summernote" id="description" name="ajax[description]" aria-multiline="true"></textarea>
                    </div>
                </form>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="question-status-fields" data-status_label="Accepted">
                            <div class="col-12 col-md-12">
                                <div class="form-group custom-switches-stacked mt-2">
                                    <label class="custom-switch pl-0">
                                        <input type="checkbox" name="image_question" id="image_question" value="1" class="custom-switch-input"/>
                                        <span class="custom-switch-indicator"></span>
                                        <label class="custom-switch-description mb-0 cursor-pointer" for="image_question">Image Question</label>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-12">
                                <div class="form-group custom-switches-stacked mt-2">
                                    <label class="custom-switch pl-0">
                                        ...
                                        <span class="custom-switch-indicator"></span>
                                        <label class="custom-switch-description mb-0 cursor-pointer" for="word_problem">Word Problem</label>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-12">
                                <div class="form-group custom-switches-stacked mt-2">
                                    <label class="custom-switch pl-0">
                                        <input type="checkbox" name="new_glossary" id="new_glossary" value="1" class="custom-switch-input"/>
                                        <span class="custom-switch-indicator"></span>
                                        <label class="custom-switch-description mb-0 cursor-pointer" for="new_glossary">New Glossary</label>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-12 glossary_illustration_field hide">
                                <div class="form-group custom-switches-stacked mt-2">
                                    <label class="custom-switch pl-0">
                                        <input type="checkbox" name="glossary_with_illustration" id="glossary_with_illustration" value="1" class="custom-switch-input"/>
                                        <span class="custom-switch-indicator"></span>
                                        <label class="custom-switch-description mb-0 cursor-pointer" for="glossary_with_illustration">Glossary with Illustration</label>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-12">
                                <div class="form-group custom-switches-stacked mt-2">
                                    <label class="custom-switch pl-0">
                                        ...
                                        <span class="custom-switch-indicator"></span>
                                        <label class="custom-switch-description mb-0 cursor-pointer" for="publish_question">Publish</label>
                                    </label>
                                </div>
                            </div>
                        </div>
