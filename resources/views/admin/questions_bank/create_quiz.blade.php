                                        ...
                                        <div class="leform-toolbars">
                                            ...
                                            <div class="leform-pages-bar">
                                                <ul class="leform-pages-bar-items">
                                                    ...
                                                    <li class="leform-pages-add" onclick="return leform_pages_add();"><label><i class="fas fa-plus"></i> Add Page</label></li>
                                                </ul>
                                            </div>
