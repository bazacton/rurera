        ...
        <div class="row">
            <div class="col-12 col-md-4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="ajax[{{ !empty($quiz) ? $quiz->id : 'new' }}][title]" value="{{ !empty($quiz) ? $quiz->title : old('title') }}" class="js-ajax-title form-control "
                           placeholder=""/>
                    <div class="invalid-feedback"></div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" value="{{ !empty($quiz) ? $quiz->mastery_points : old('mastery_points') }}" name="ajax[{{ !empty($quiz) ? $quiz->id : 'new' }}][mastery_points]"
                ...
                <div class="conditional-fields assessment-fields {{$assessment_hide_class}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" value="{{ !empty($quiz) ? $quiz->attempt : old('attempt') }}" name="ajax[{{ !empty($quiz) ? $quiz->id : 'new' }}][attempt]"
                               class="form-control @error('attempt')  is-invalid @enderror" placeholder=""/>
                    </div>

                    <div class="form-group">
                        <label class="input-label">Total Time</label>
                        <input type="number" value="{{ !empty($quiz) ? $quiz->time : old('time') }}" name="ajax[{{ !empty($quiz) ? $quiz->id : 'new' }}][time]"
                               class="form-control @error('time')  is-invalid @enderror" placeholder=""/>
                    </div>

                    <div class="form-group">
                        <label class="input-label">Display no of Questions</label>
                        <input type="number" value="{{ !empty($quiz) ? $quiz->display_number_of_questions : old('display_number_of_questions') }}"
                               name="ajax[{{ !empty($quiz) ? $quiz->id : 'new' }}][display_number_of_questions]"
                               class="form-control @error('display_number_of_questions')  is-invalid @enderror" placeholder=""/>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" value="{{ !empty($quiz_settings) ? $quiz_settings['Below']->questions : '6' }}" name="ajax[{{ !empty($quiz) ? $quiz->id : 'new' }}][Below]"
                        ...
                        <div class="col-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" value="{{ !empty($quiz_settings) ? $quiz_settings['Below']->points_percentage : '25' }}"
                                       name="ajax[{{ !empty($quiz) ? $quiz->id : 'new' }}][Below_points]" class="form-control" placeholder=""/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" value="{{ !empty($quiz_settings) ? $quiz_settings['Emerging']->questions : '15' }}" name="ajax[{{ !empty($quiz) ? $quiz->id : 'new' }}][Emerging]"
                                       class="form-control" placeholder=""/>
                            </div>
                        </div>
                        <div class="col-6 col-md-6">
                            <div class="form-group">
                                <label class="input-label">Points %</label>
                                <input type="number" value="{{ !empty($quiz_settings) ? $quiz_settings['Emerging']->points_percentage : '20' }}"
                                       name="ajax[{{ !empty($quiz) ? $quiz->id : 'new' }}][Emerging_points]" class="form-control @error('title')  is-invalid @enderror" placeholder=""/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" value="{{ !empty($quiz_settings) ? $quiz_settings['Expected']->questions : '20' }}" name="ajax[{{ !empty($quiz) ? $quiz->id : 'new' }}][Expected]"
                        ...
                        <div class="col-6 col-md-6">
                            <div class="form-group">
                                <label class="input-label">Points %</label>
                                <input type="number" value="{{ !empty($quiz_settings) ? $quiz_settings['Expected']->points_percentage : '30' }}"
                                       name="ajax[{{ !empty($quiz) ? $quiz->id : 'new' }}][Expected_points]" class="form-control @error('title')  is-invalid @enderror" placeholder=""/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" value="{{ !empty($quiz_settings) ? $quiz_settings['Exceeding']->questions : '15' }}"
                        ...
                        <div class="col-6 col-md-6">
                            <div class="form-group">
                                <label class="input-label">Points %</label>
                                <input type="number" value="{{ !empty($quiz_settings) ? $quiz_settings['Exceeding']->points_percentage : '15' }}"
                                       name="ajax[{{ !empty($quiz) ? $quiz->id : 'new' }}][Exceeding_points]" class="form-control @error('title')  is-invalid @enderror" placeholder=""/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" value="{{ !empty($quiz_settings) ? $quiz_settings['Challenge']->questions : '10' }}"
                        ...
                        <div class="col-6 col-md-6">
                            <div class="form-group">
                                <label class="input-label">Points %</label>
                                <input type="number" value="{{ !empty($quiz_settings) ? $quiz_settings['Challenge']->points_percentage : '10' }}"
                                       name="ajax[{{ !empty($quiz) ? $quiz->id : 'new' }}][Challenge_points]" class="form-control @error('title')  is-invalid @enderror" placeholder=""/>
                            </div>
                        </div>
                    </div>
                </div>
