                        ...
                        <div class="hap-content-area">
                            ...
                            <div class="hap-content-box">
                                ...
                                <div class="wrap leform-admin leform-admin-editor">
                                        ...
                                        <div class="leform-toolbars">
                                            ...
                                            <div class="leform-pages-bar">
                                                <ul class="leform-pages-bar-items">
                                                    <li class="leform-pages-bar-item" data-id="1" data-name="{{$quiz->title}}"><label onclick="return leform_pages_activate(this);">{{$quiz->title}}</label><span><a href="#" data-type="page" onclick="return leform_properties_open(this);"><i class="fas fa-cog"></i></a></span></li>
                                                </ul>
                                            </div>
                                    ...
                                    $quiz_layout = array();
                                    $quiz_layout[] = $quiz->quiz_layout; 
                                    
                                    @endphp;
                                    <script>
                                         //@php echo 'var raw_data_json = ' . json_encode($quiz_layout[0]); @endphp;
                                         //console.log(raw_data_json);
                                        ...
                                        var leform_form_pages_raw = [{"general": "general", "name": "@php echo $quiz->title @endphp", "id": 1, "type": "page"}];
                                        //@php echo 'var leform_form_elements_raw = ' . json_encode($quiz_layout); @endphp;
                                        @php echo 'var leform_form_elements_raw = ' . json_encode($quiz_layout); @endphp;
