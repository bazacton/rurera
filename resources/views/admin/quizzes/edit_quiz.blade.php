                            ...
                            <div class="hap-content-box">
                                ...
                                <div class="wrap rureraform-admin rureraform-admin-editor">
                                        ...
                                        <div class="rureraform-toolbars">
                                            ...
                                            <div class="rureraform-pages-bar">
                                                <ul class="rureraform-pages-bar-items">
                                                    <li class="rureraform-pages-bar-item" data-id="1" data-name="{{$quiz->title}}"><label onclick="return rureraform_pages_activate(this);">{{$quiz->title}}</label><span><a href="#" data-type="page" onclick="return rureraform_properties_open(this);"><i class="fas fa-cog"></i></a></span></li>
                                                </ul>
                                            </div>
                                    ...
                                    <script>
                                        ...
                                        var rureraform_form_pages_raw = [{"general": "general", "name": "@php echo $quiz->title @endphp", "id": 1, "type": "page"}];
                                        //@php echo 'var rureraform_form_elements_raw = ' . json_encode($quiz_layout); @endphp;
                                        @php echo 'var rureraform_form_elements_raw = ' . json_encode($quiz_layout); @endphp;
