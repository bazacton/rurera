...
!(function (y, M, L, a) {
    (y.fn.flipBook = function (e) {
        ...
        (y.fn.flipBook.options = {
            ...
            deeplinkingPrefix: "",
            assets: { preloader: "images/preloader.jpg", overlay: "images/overlay.png", flipMp3: "mp3/turnPage.mp3", spinner: "images/spinner.gif" },
            pdfUrl: null,
            ...
            currentPage: { enabled: !0, title: "Current page", vAlign: "bottom", hAlign: "right", marginH: 0, marginV: 0, color: "", background: "" },
        ...
        (FLIPBOOK.Main = function (e, t) {
            ...
            var o,
                i,
                s,
                a = L.createElement("div").style,
                r = (function () {
                    for (var e = "t,webkitT,MozT,msT,OT".split(","), t = 0, o = e.length; t < o; t++) if (e[t] + "ransform" in a) return e[t].substr(0, e[t].length - 1);
                    return !1;
                })(),
            ...
            (this.msie = M.navigator.userAgent.indexOf("MSIE ")),
                (this.isAndroid = l),
                (this.has3d = d),
                void 0 === FLIPBOOK.hasWebGl &&
                    (function (e) {
                        if (M.WebGLRenderingContext) {
                            for (var t = L.createElement("canvas"), o = ["webgl", "experimental-webgl", "moz-webgl", "webkit-3d"], i = !1, n = 0; n < 4; n++)
                                try {
                ...
                0 <
                    ...
                    "Microsoft Internet Explorer" == navigator.appName
                        ? ((i = navigator.userAgent), null != new RegExp("MSIE ([0-9]{1,}[.0-9]{0,})").exec(i) && (s = parseFloat(RegExp.$1)))
                        : "Netscape" == navigator.appName && ((i = navigator.userAgent), null != new RegExp("Trident/.*rv:([0-9]{1,}[.0-9]{0,})").exec(i) && (s = parseFloat(RegExp.$1))),
            ...
            var u,
                ...
                P,
                S = this.options;
            if (((S.isMobile = /iPhone|iPad|iPod|Android/i.test(navigator.userAgent)), S.isMobile)) for (var c in S.mobile) S[c] = S.mobile[c];
            function B() {
            ...
            function x() {
                ...
                n.disposed ||
                    ((e = M.location.hash),
                    (o = t = n.getPageFromHash()) < 1 ? (t = 1) : n.numPages && t > n.numPages && (t = n.numPages),
                    t &&
                        ((t = S.rightToLeft && S.pages && S.pages.length ? S.pages.length - t + 1 : t),
                        n.started
                            ? n.Book && (n.lightbox && !FLIPBOOK.lightboxOpened && (n.lightbox.openLightbox(), n.lightboxStart()), n.goToPage(t, -1 == e.indexOf("flip")))
                            : ((S.startPage = o),
                              S.lightBox &&
                                  (O(),
                                  S.lightBoxFullscreen &&
                                      setTimeout(function () {
                                          n.toggleExpand();
                                      }, 100)))));
            }
            function O() {
                var t;
                S.fillPreloader.enabled
                    ? ((n.$fillPreloader = y("<div>").addClass("flipbook-fillPreloader")),
                      ((t = new Image()).src = S.fillPreloader.imgEmpty),
                      (t.onload = function () {
                          var e = new Image();
                          (e.src = S.fillPreloader.imgFull),
                              (e.onload = function () {
            ...
            function T() {
                n.initialized || ((n.id = Date.now()), n.addPageItems(), S.pdfMode ? n.initPdf() : n.initJpg(), n.setLoadingProgress(0.1), n.lightbox && n.options.lightboxShowMenu && n.createMenu(), (n.initialized = !0));
            }
            (this.strings = S.strings),
                (S.pageShininess = S.pageShininess / 2),
                (this.s = 0),
                S.googleAnalyticsTrackingCode &&
                    ((this.gaCode = S.googleAnalyticsTrackingCode),
                    M.ga ||
                        ((g = L),
                        (f = "script"),
                        (b = "ga"),
                        ((u = M).GoogleAnalyticsObject = b),
                        (u.ga =
                            u.ga ||
                            function () {
                ...
                S.isMobile &&
                    ((S.singlePageMode = !!S.singlePageModeIfMobile || S.singlePageMode),
                    S.viewModeMobile && (S.viewMode = S.viewModeMobile),
                    S.pageTextureSizeMobile && (S.pageTextureSize = S.pageTextureSizeMobile),
                    S.pageTextureSizeMobileSmall && (S.pageTextureSizeSmall = S.pageTextureSizeMobileSmall),
                    (S.touchSwipeEnabled = !0)),
                "3dSinglePage" == S.viewMode && (S.singlePageMode = !0),
                "2dSinglePage" == S.viewMode && ((S.singlePageMode = !0), (S.viewMode = "2d")),
                S.singlePageMode && ("2d" != S.viewMode && "swipe" != S.viewMode && (S.viewMode = "3d"), S.rightToLeft && (S.viewMode = "swipe")),
                S.singlePageMode && "3d" == S.viewMode && (S.rightToLeft = !1),
                "simple" == S.viewMode && ((S.viewMode = "3d"), (S.instantFlip = !0)),
                (S.sideMenuPosition = S.rightToLeft ? "right" : "left"),
                "webgl" == S.viewMode && (!this.hasWebGl || (parseFloat(!!(w = (v = (v || navigator.userAgent).toLowerCase()).match(/android\s([0-9\.]*)/)) && w[1]) < S.minimumAndroidVersion && this.isAndroid)) && (S.viewMode = "3d"),
                "3d" != S.viewMode || n.has3d || (S.viewMode = "2d"),
                (this.webgl = "webgl" == S.viewMode),
                S.menuFloating && ((S.menuOverBook = !0), (S.sideMenuOverMenu = !0)),
                S.menu2Floating && ((S.menu2OverBook = !0), (S.sideMenuOverMenu2 = !0)),
                S.menuTransparent && ((S.menuOverBook = !0), (S.sideMenuOverMenu = !0), (S.menuBackground = "none")),
                S.menu2Transparent ? ((S.menu2OverBook = !0), (S.sideMenuOverMenu2 = !0), (S.menu2Background = "none")) : (S.sideMenuOverMenu2 = !1),
                S.menuOverBook && (S.sideMenuOverMenu = !0),
                S.menu2OverBook && (S.sideMenuOverMenu2 = !0),
                (S.isMobile && S.pdfBrowserViewerIfMobile && S.pdfUrl) || (S.isIE && S.pdfBrowserViewerIfIE && S.pdfUrl)
                    ? S.lightBox && !S.lightBoxOpened
                        ? this.$elem
                              ...
                              .css("cursor", "pointer")
                        : B()
                    : ((S.pdfMode = Boolean(S.pdfUrl && "" != S.pdfUrl)),
                      S.backgroundTransparent && (S.backgroundColor = "none"),
                      (this.wrapper = y(L.createElement("div")).addClass("flipbook-main-wrapper")),
                      "" != S.backgroundColor && this.wrapper.css("background", S.backgroundColor),
                      "" != S.backgroundPattern && this.wrapper.css("background", "url(" + S.backgroundPattern + ") repeat"),
                      "" != S.backgroundImage && (this.wrapper.css("background", "url(" + S.backgroundImage + ") no-repeat"), this.wrapper.css("background-size", "cover"), this.wrapper.css("background-position", "center center")),
                      ...
                      S.hideMenu && (this.bookLayer.css("bottom", "0"), (S.menuOverBook = !0)),
                      (S.pagesOriginal = JSON.parse(JSON.stringify(S.pages))),
                      (this.book = y(L.createElement("div")).addClass("book").appendTo(n.bookLayer)),
                      S.preloader
                          ? (this.preloader = S.preloader)
                          : !y(".flipbook-preloader").length && S.lightBox
                          ? (this.preloader = y('<div class="flipbook-preloader cssload-container"><div class="cssload-speeding-wheel"/><div class="flipbook-loading-text"></div><div class="flipbook-loading-bg"></div></div>'))
                          : S.lightBox
                          ? (this.preloader = y(".flipbook-preloader"))
                          : (this.preloader = y('<div class="flipbook-preloader-2 cssload-container"><div class="cssload-speeding-wheel"/><div class="flipbook-loading-text"></div><div class="flipbook-loading-bg"></div></div>')),
                      y(".flipbook-loading-text").text(S.preloaderText),
                      this.setLoadingProgress(0),
                      !S.deeplinkingPrefix && S.deeplinking && S.deeplinking.prefix && (S.deeplinkingPrefix = S.deeplinking.prefix),
                      (S.deeplinkingEnabled = S.deeplinkingPrefix || S.deeplinkingEnabled || (S.deeplinking && S.deeplinking.enabled)),
                      S.deeplinkingEnabled &&
                          (x(),
                          y(M).bind("hashchange", function (e) {
                              x();
                          })),
                      ...
                      P.on("pdfinit", function () {
                          (S.tableOfContent = n.pdfService.outline || S.tableOfContent),
                              (S.doublePage = n.pdfService.double),
                              S.doublePage || (S.backCover = n.pdfService.numPages % 2 == 0),
                              (n.viewportOriginal = n.pdfService.viewports[0]),
                              (S.firstPage = { width: n.pdfService.viewports[0].width, height: n.pdfService.viewports[0].height, ratio: n.pdfService.viewports[0].width / n.pdfService.viewports[0].height }),
                              1 < n.pdfService.numPages && (S.secondPage = { width: n.pdfService.viewports[1].width, height: n.pdfService.viewports[1].height, ratio: n.pdfService.viewports[1].width / n.pdfService.viewports[1].height }),
                              (S.numPages = n.pdfService.numPages),
                              1 == S.numPages &&
                                  ((S.viewMode = "swipe"),
                                  (S.singlePageMode = !0),
                                  (S.btnNext.enabled = !1),
                                  (S.btnPrev.enabled = !1),
                                  (S.btnFirst.enabled = !1),
                                  (S.btnLast.enabled = !1),
                                  (S.sideNavigationButtons = !1),
                                  (S.btnAutoplay.enabled = !1),
                                  (S.printMenu = !1),
                                  (S.downloadMenu = !1),
                                  (n.webgl = !1));
                      ...
                      (this.model = P),
                      S.lightBox
                          ? ((S.btnClose.enabled = !0),
                            (this.lightbox = new FLIPBOOK.Lightbox(this, this.wrapper, S)),
                            ...
                            this.$elem.css("cursor", "pointer").bind("tap click", function (e) {
                                (n.lightboxStartPage = y(this).attr("data-page")),
                                    n.started
                                        ? (n.lightboxStart(),
                                          S.lightBoxFullscreen &&
                                              setTimeout(function () {
                            ...
                            S.lightBoxOpened
                                ? (O(), y(M).trigger("r3d-lightboxloadingstarted"))
                                : S.lightboxPreload &&
                                  ...
                                  S.pdfMode &&
                                      ...
                                      void 0 !== FLIPBOOK.PdfService || FLIPBOOK.scriptsAdded[FLIPBOOK.pdfServiceSrc] || n.loadScript(FLIPBOOK.pdfServiceSrc, function () {}),
                                      S.btnSearch.enabled && (FLIPBOOK.scriptsAdded[FLIPBOOK.markSrc] || n.loadScript(FLIPBOOK.markSrc, function () {}))),
                                  "webgl" == S.viewMode && ("undefined" != typeof THREE || FLIPBOOK.scriptsAdded[FLIPBOOK.threejsSrc] || n.loadScript(FLIPBOOK.threejsSrc, function () {}))),
                            (this.fullscreenElement = L.documentElement))
                          : ((S.btnClose.enabled = !1), this.preloader.appendTo(this.wrapper), this.wrapper.appendTo(this.$elem), (this.fullscreenElement = this.$elem[0]), O()));
        }),
        (FLIPBOOK.Main.prototype = {
            ...
            setHash: function (e) {
                e < 1 && (e = 1),
                    "#" + this.options.deeplinkingPrefix + e != M.location.hash &&
                        this.options.deeplinkingEnabled &&
                        this.Book.enabled &&
                        this.hash != e &&
                        ((M.location.hash = "#" + this.options.deeplinkingPrefix + String(e)), (this.hash = e));
            },
            clearHash: function () {
                var e,
                    t,
            ...
            updateCurrentPage: function () {
                ...
                i % 2 == 1 && i++,
                    ...
                    this.options.singlePageMode || this.Book.singlePage || 1 == this.Book.view
                        ? ((e = this.Book.getCurrentPageNumber ? this.Book.getCurrentPageNumber() : (t && i--, i + 1)), this.setHash(e), (this.cPage = [e - 1]))
                        : (o < i || (i == o && o % 2 == 0) ? ((e = o), (this.cPage = [o - 1])) : i < 1 ? ((e = 1), (this.cPage = [0])) : ((e = String(i) + "-" + String(i + 1)), (this.cPage = [i - 1, i])), this.setHash(i)),
                    t ? (this.enableNext(0 < i), this.enablePrev(this.Book.canFlipPrev() || i < o - 1)) : (this.enablePrev(0 < i), this.enableNext(this.Book.canFlipNext() || i < o - 1)),
                    2 == this.cPage.length
                    ...
                    void 0 !== this.currentPage &&
                        ...
                        e != this.currentPageValue &&
                            ...
                            this.resize(),
                            y(this).trigger({ type: "pagechange", page: this.currentPageValue, name: this.options.name }),
                            y(M).trigger({ type: "r3d-pagechange", page: this.currentPageValue, name: this.options.name }),
                    ...
                    this.loadPage(0, this.options.pageTextureSize, function () {
                        ...
                        1 == n.pages.length
                            ? ((e = n.pages[0].img),
                              ...
                              s.start())
                            : s.loadPage(1, n.pageTextureSize, function () {
                                  var e = n.pages[0].img,
                                      t = n.pages[1].img,
                                      o = e.width / e.height,
                                      i = t.width / t.height;
                ...
                this.options.pdfMode
                    ...
                    ? this.loadPageJSON(i, function (e) {
                          ...
                          o.htmlContentInitialized ||
                              ((t = L.createElement("div")).classList.add("flipbook-page-htmlContent"),
                              t.classList.add("page" + String(i)),
                              (t.innerHTML = decodeURIComponent(e.data)),
                              o.htmlContent && y(t).append(y(o.htmlContent)),
                              (o.htmlContent = t),
                              y(o.htmlContent)
                                  .find(".internalLink")
                                  .each(function () {
            ...
            loadPageJSON: function (e, t) {
                ...
                if (!o.jsonLoading && !o.jsonLoaded)
                    return (
                        (o.jsonLoading = !0),
                        void y.getJSON(o.json, function (e) {
            ...
            loadPage: function (e, t, o) {
                ...
                this.options.pdfMode && !s
                    ...
                    : (i = (n = this).options.pages[e]).img
                    ? i.imgLoaded
                        ? n.pageLoaded({ index: e, size: t, image: i.img }, o)
                        : setTimeout(function () {
                              n.loadPage(e, t, o);
                          }, 300)
                    : ((i.img = L.createElement("img")),
                      i.img.setAttribute("data-id", e),
                      (i.img.onload = function () {
                          (i.imgLoaded = !0), n.pageLoaded({ index: e, size: t, image: i.img }, o);
                      }),
                      "webgl" == this.options.viewMode && (i.img.crossOrigin = "Anonymous"),
                      "https:" == location.protocol ? (i.src = i.src.replace("http://", "https://")) : "http:" == location.protocol && (i.src = i.src.replace("https://", "http://")),
                      (i.img.src = i.src));
            },
            ...
            createBook: function () {
                var e,
                    ...
                    o = this.options;
                if (
                    ("material" != o.icons || FLIPBOOK.MaterialIconsLoaded || ((FLIPBOOK.MaterialIconsLoaded = !0), y("head").append('<link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">')),
                ...
                if ((this.setLoadingProgress(1), this.initEasing(), n.options.doublePage && 2 < n.options.pages.length)) {
                    for (var i = [n.options.pages[0]], s = 1; s <= n.options.pages.length - 2; s++) {
                        var a,
                            r = { src: (a = n.options.pages[s]).src, thumb: a.thumb, title: a.title, htmlContent: a.htmlContent, json: a.json, side: "left" },
                            l = { src: a.src, thumb: a.thumb, title: a.title, htmlContent: a.htmlContent, json: a.json, side: "right" };
                        i.push(r), i.push(l);
                    }
                    n.options.backCover
                        ? i.push(n.options.pages[n.options.pages.length - 1])
                        : ((r = { src: (a = n.options.pages[n.options.pages.length - 1]).src, thumb: a.thumb, title: a.title, htmlContent: a.htmlContent, json: a.json, side: "left" }),
                          (l = { src: a.src, thumb: a.thumb, title: a.title, htmlContent: a.htmlContent, json: a.json, side: "right" }),
                          i.push(r),
                          i.push(l)),
                        (n.options.pages = i);
                ...
                "webgl" == n.options.viewMode
                    ? (((e = n.options).scroll = n.scroll), ((e.parent = n).Book = new FLIPBOOK.BookWebGL(n.book[0], t, e)), (n.webglMode = !0), n.initSwipe(), d())
                    : "swipe" == n.options.viewMode
                    ? ((n.Book = new FLIPBOOK.BookSwipe(n.book[0], n.bookLayer[0], t, o)), n.initSwipe())
                    : ("2d" != n.options.viewMode && (n.options.viewMode = "3d"), (n.Book = new FLIPBOOK.Book3(n.book[0], t, o)), n.initSwipe(), (n.webglMode = !1), d()),
                    this.resize(),
                    n.Book.enable(),
                            ...
                            switch (s.type) {
                                ...
                                case "link":
                                    (a = y("<a>")
                                        ...
                                        s.url ? a.attr("href", s.url).attr("target", "_blank") : s.page && ((n = "#" + this.options.deeplinkingPrefix + s.page), s.flip && (n += "flip"), a.attr("href", n)),
                                        (o.htmlContent += a[0].outerHTML);
                                    break;
                                case "video":
                                    var a = y("<video>").addClass("flipbook-page-item");
                                    s.width && a.attr("width", s.width),
                                        s.height && a.attr("height", s.height),
                                        s.x && a.css("left", s.x + "px"),
                                        s.y && a.css("top", s.y + "px"),
                                        s.controls && a.prop("controls", "true"),
                                        s.autoplay && a.prop("autoplay", "true");
                                ...
                                if (("end" == t || "cancel" == t) && n < 200 && i < 10) {
                                    ...
                                    "toolMove" != l.tool ||
                                        ...
                                        (null == l.clickTimer
                                            ...
                                            : (clearTimeout(l.clickTimer), (l.clickTimer = null), (r = l.options.zoomTime), l.zoom >= l.options.zoomMax ? l.zoomTo(l.options.zoomMin, r, e) : l.zoomTo(l.options.zoomMax, r, e)));
                                } else {
            ...
            toggleMenu: function () {
                this.menuShowing
                    ? ((this.menuShowing = !1), this.bookLayer.css("bottom", "0px"), this.menuBottom.fadeOut(), this.currentPageHolder.fadeOut(), y(".flipbook-nav").fadeOut())
                    : ((this.menuShowing = !0), this.bookLayer.css("bottom", this.menuBottom.height() + "px"), this.menuBottom.fadeIn(), this.currentPageHolder.fadeIn(), y(".flipbook-nav").fadeIn()),
                    this.Book.onResize();
            },
            ...
            createButton: function (t) {
                ...
                function f(e) {
                    e.css({ width: g + "px", "font-size": u + "px", margin: h + "px", "border-radius": l + "px", "text-shadow": o.btnTextShadow, "box-shadow": o.btnShadow, border: d, color: s, background: i, "text-shadow": r }),
                        s && e.removeClass("skin-color"),
                        i && e.removeClass("skin-color-bg");
                }
                (p.$icon = this.createIcon(t).appendTo(p)),
                    f(p.$icon),
                    t.iconAlt2 && ((p.$iconAlt = this.createIcon(t, !0).appendTo(p).hide()), f(p.$iconAlt)),
                    (p.icon = t.icon),
                    (p.iconAlt = t.iconAlt),
                    c && ((p.icon = t.icon2), (p.iconAlt = t.iconAlt2), (t.icon = t.icon2), (t.iconAlt = t.iconAlt2)),
                    t.onclick &&
                    ...
                    (a || n) &&
                        p
                            .mouseenter(function () {
                                p.find("." + p.icon.replace("fas ", "")).css({ color: a, background: n }), p.$iconAlt && p.find("." + p.iconAlt.replace("fas ", "")).css({ color: a, background: n });
                            })
                            .mouseleave(function () {
                                p.find("." + p.icon.replace("fas ", "")).css({ color: s, background: i }), p.$iconAlt && p.find("." + p.iconAlt.replace("fas ", "")).css({ color: s, background: i });
                            });
                var b =
                    "top" == t.vAlign
                        ? o.menu2Floating
            ...
            createMenu: function () {
                if (!this.menuBottom) {
                    var e = this.options,
                        ...
                        i = this;
                    (this.menuBottom = y(L.createElement("div"))
                        ...
                        (this.menuTop = y(L.createElement("div"))
                        ...
                        (this.menuBL = y(L.createElement("div")).addClass("flipbook-menu flipbook-menu-left").appendTo(this.menuBottom)),
                        (this.menuBC = y(L.createElement("div")).addClass("flipbook-menu flipbook-menu-right").appendTo(this.menuBottom)),
                        (this.menuBR = y(L.createElement("div")).addClass("flipbook-menu flipbook-menu-right").appendTo(this.menuBottom)),
                        (this.menuTL = y(L.createElement("div")).addClass("flipbook-menu flipbook-menu-left").appendTo(this.menuTop)),
                        (this.menuTC = y(L.createElement("div")).addClass("flipbook-menu flipbook-menu-right").appendTo(this.menuTop)),
                        (this.menuTR = y(L.createElement("div")).addClass("flipbook-menu flipbook-menu-right").appendTo(this.menuTop)),
                        e.isMobile &&
                        ...
                        e.sideNavigationButtons &&
                            ((this.btnNext = y('<div class="flipbook-nav"><div class="flipbook-arrow-wrapper"></div></div>')
                            ...
                            (this.btnPrev = y('<div class="flipbook-nav"><div class="flipbook-arrow-wrapper"></div></div>')
                            ...
                            e.btnFirst.enabled &&
                                ((this.btnFirst = y('<div class="flipbook-nav"><div class="flipbook-arrow-wrapper"></div></div>')
                                    .appendTo(this.bookLayer)
                                    .bind("tap click", function (e) {
                                        i.btnFirst.disabled ||
                            ...
                            e.btnLast.enabled &&
                                ((this.btnLast = y('<div class="flipbook-nav"><div class="flipbook-arrow-wrapper"></div></div>')
                                    .appendTo(i.bookLayer)
                                    .bind("tap click", function (e) {
                                        i.btnLast.disabled ||
            ...
            onButtonClick: function (e, t) {
                ...
                switch (r) {
                    ...
                    case "btnPrint":
                        ...
                        break;
                    case "btnDownloadPdf":
                        l.btnDownloadPdf.forceDownload
                            ? ((i = l.btnDownloadPdf.url), ((n = L.createElement("a")).href = i), (s = n.href.split("/").pop().split("#")[0].split("?")[0]), (n.download = s), L.body.appendChild(n), n.click(), L.body.removeChild(n))
                            : ((a = l.btnDownloadPdf.openInNewWindow || (l.btnDownloadPdf.openInNewWindow, 1) ? "_blank" : "_self"), M.open(l.btnDownloadPdf.url, a)),
                            this.gaCode && ga("send", { hitType: "event", eventCategory: "Flipbook : " + l.name, eventAction: "download PDF", eventLabel: l.btnDownloadPdf.url, nonInteraction: !0 });
                        break;
                    case "btnSound":
                        this.toggleSound();
                        break;
            ...
            handleFsChange: function (e) {
                ...
                this.Book &&
                    this.Book.enabled &&
                    ((t = y(this.fullscreenElement)),
                    (L.fullscreenElement || L.webkitFullscreenElement || L.mozFullScreenElement || L.msFullscreenElement) === this.fullscreenElement || this.isFullscreen
                        ? (t.addClass("flipbook-browser-fullscreen"), (this.fullscreenActive = !0), this.options.onfullscreenenter && this.options.onfullscreenenter.call(this))
                        : (t.removeClass("flipbook-browser-fullscreen"), (this.fullscreenActive = !1), this.options.onfullscreenexit && this.options.onfullscreenexit.call(this)),
            ...
            createLogo: function () {
                ...
                t.logoImg &&
                    ((t.isMobile && t.logoHideOnMobile) ||
                        ((e = y("<img>").attr("src", t.logoImg).attr("style", t.logoCSS).appendTo(this.wrapper)),
            ...
            zoomOut: function (e) {
                var t,
                    o = this.zoom / this.options.zoomStep;
            ...
            zoomIn: function (e) {
                var t,
                    o = this.zoom * this.options.zoomStep;
                1 < o && this.zoom < 1 && (o = 1),
                    this.bookLayer.height() * o > this.options.zoomSize && (o = this.options.zoomSize / this.bookLayer.height()),
                    this.zoom != o && ((this.zoom = o), (t = this.options.zoomTime), this.zoomTo(this.zoom, t, e));
            },
            nextPage: function () {
            ...
            createCurrentPage: function () {
                ...
                d.css("margin", i.currentPage.marginV + "px " + i.currentPage.marginH + "px"),
                    n || (e += "skin-color "),
                    d.addClass(e).css({ color: a, background: s, "text-shadow": r, "border-radius": l + "px" }),
                    i.currentPage.order && d.css("order", i.currentPage.order),
                    (this.currentPageHolder = d),
                    (this.currentPage = y(L.createElement("div")).addClass("flipbook-currentPageNumber").appendTo(d));
                var h = y("<form>")
                    .appendTo(d)
                    .submit(function (e) {
                ...
                (this.currentPageInput = y('<input type="text" maxlength="4">')
            ...
            createToc: function () {
                ...
                if ((e && e.length) || !this.pdfService || this.pdfService.outlineLoaded) {
                    if (
                        ((this.tocHolder = y("<div>").addClass("flipbook-tocHolder flipbook-side-menu skin-color-bg").appendTo(this.wrapper).css(this.options.sideMenuPosition, "0").hide()),
                        this.createMenuHeader(this.tocHolder, this.strings.tableOfContent, this.toggleToc),
                        (this.toc = y("<div>").addClass("flipbook-toc").appendTo(this.tocHolder)),
                        (this.tocScroller = y("<div>").addClass("flipbook-toc-scroller").appendTo(this.toc)),
                        (this.tocScroll = new FLIPBOOK.IScroll(i.toc[0], { bounce: !1, mouseWheel: !0, scrollbars: !0, interactiveScrollbars: !0 })),
                        e && 0 < e.length)
                    ) {
                        this.options.pages;
                        ...
                        for (var o = this.options.pages, t = 0; t < o.length; t++) {
                            var n,
                                s = o[t].title;
                            "" != s && void 0 !== s && ((n = { title: s, page: String(t + 1) }), this.createTocItem(n));
                        }
                    this.initColors(), this.tocScroll.refresh(), (this.tocCreated = !0), this.toggleToc();
                } else
                    i.pdfService.loadOutline(function (e) {
                        ...
                        new PDFLinkService({ eventBus: t }).setViewer(o), i.createToc();
                    });
            },
            createTocItem: function (i, e, t) {
                        ...
                        .bind("touchend click", function (e) {
                            ...
                            e.stopPropagation(),
                                ...
                                n.tocScroll.moved ||
                                    ...
                                    !i.page && i.dest
                                        ? "string" == typeof i.dest
                                            ? n.pdfService.pdfDocument.getDestination(i.dest).then(function (e) {
                                                  o(e);
                                              })
                                            : o(i.dest)
                                        : ((t = Number(i.page)),
                ...
                if (
                    ...
                    y(L.createElement("span")).appendTo(s).width("25px").css("display", "inline-block").css("text-align", "right").text(i.page),
            ...
            togglePrintMenu: function () {
                ...
                this.printMenu
                    ...
                    : ((this.printMenu = y('<div class="flipbook-sub-menu flipbook-font">').appendTo(this.wrapper)),
                      (e = y('<idv class="flipbook-sub-menu-center">').appendTo(this.printMenu)),
                      (t = y('<idv class="flipbook-sub-menu-content skin-color-bg">').appendTo(e)),
                      this.createMenuHeader(t, this.strings.print, this.togglePrintMenu),
                      y('<a><div class="c-p skin-color flipbook-btn">' + this.strings.printCurrentPage + "</div></a>")
                          .appendTo(t)
                          .bind("touchend click", function (e) {
                              o.printPage(o.cPage[0], this);
                          }),
                      y('<a><div class="c-l-p skin-color flipbook-btn">' + this.strings.printLeftPage + "</div></a>")
                          .appendTo(this.printMenu)
                          .appendTo(t)
                          .bind("touchend click", function (e) {
                              o.printPage(o.cPage[0], this);
                          }),
                      y('<a><div class="c-r-p skin-color flipbook-btn">' + this.strings.printRightPage + "</div></a>")
                          .appendTo(this.printMenu)
                          .appendTo(t)
                          .bind("touchend click", function (e) {
                              o.printPage(o.cPage[1], this);
                          }),
                      y('<a><div class="skin-color flipbook-btn">' + this.strings.printAllPages + "</div></a>")
                          .appendTo(t)
                          .bind("touchend click", function (e) {
                              o.togglePrintWindow();
                          }),
            ...
            toggleDownloadMenu: function () {
                ...
                this.dlMenu
                    ...
                    : ((this.dlMenu = y('<div class="flipbook-sub-menu flipbook-font">').appendTo(this.wrapper)),
                      (e = y('<idv class="flipbook-sub-menu-center">').appendTo(this.dlMenu)),
                      (t = y('<idv class="flipbook-sub-menu-content skin-color-bg">').appendTo(e)),
                      this.createMenuHeader(t, this.strings.download, this.toggleDownloadMenu),
                      y('<a><div class="c-p skin-color flipbook-btn">' + this.strings.downloadCurrentPage + "</div></a>")
                          .appendTo(t)
                          .bind("touchend click", function (e) {
                              i.downloadPage(i.cPage[0], this);
                          }),
                      y('<a><div class="c-l-p skin-color flipbook-btn">' + this.strings.downloadLeftPage + "</div></a>")
                          .appendTo(t)
                          .bind("touchend click", function (e) {
                              i.downloadPage(i.cPage[0], this);
                          }),
                      y('<a><div class="c-r-p skin-color flipbook-btn">' + this.strings.downloadRightPage + "</div></a>")
                          .appendTo(t)
                          .bind("touchend click", function (e) {
                              i.downloadPage(i.cPage[1], this);
                          }),
                      y('<a><div class="skin-color flipbook-btn">' + this.strings.downloadAllPages + "</div></a>")
                          .appendTo(t)
                          .bind("touchend click", function (e) {
            ...
            toggleShareMenu: function () {
                ...
                this.shareMenu
                    ...
                    : ((this.shareMenu = y('<div class="flipbook-sub-menu flipbook-font">').appendTo(this.wrapper)),
                      (e = y('<idv class="flipbook-sub-menu-center">').appendTo(this.shareMenu)),
                      (t = y('<idv class="flipbook-sub-menu-content skin-color-bg">').appendTo(e)),
                      this.createMenuHeader(t, this.options.strings.share, this.toggleShareMenu),
                      (o = y('<idv class="flipbook-share">').appendTo(t)),
                      (i = this.options),
                      (this.share = new Share(o[0], { networks: { twitter: i.twitter, facebook: i.facebook, pinterest: i.pinterest, email: i.email } })),
                      this.closeMenus(),
                ...
                this.options.pages[e] && this.options.pages[e].print
                    ...
                    o
                        ? ((i = "<!DOCTYPE html>"),
                          ...
                          (i += "</body>"),
                          (i += "</html>"),
                          (n = M.open("", "Print", "height=1600,width=800")).document.open(),
                          n.document.write(i),
                          n.document.close(),
                        ...
                        : (s = this).loadPage(e, this.options.pageTextureSize, function () {
                              s.printPage(e);
                          });
            },
            downloadPage: function (e) {
                ...
                this.options.pages[e] && this.options.pages[e].download
                    ...
                    : this.options.pages[e] &&
                      ...
                      o.getContext("2d").drawImage(this.options.pages[e].canvas[this.options.pageTextureSize], 0, 0),
                      (t = o.toDataURL("image/jpeg", 0.5))),
                    t
                        ? (((n = L.createElement("a")).href = t), (n.download = "page" + String(e + 1)), L.body.appendChild(n), n.click(), L.body.removeChild(n))
                        : (s = this).loadPage(e, this.options.pageTextureSize, function () {
                              s.downloadPage(e);
                          });
            },
            printPdf: function (e) {
                ...
                this.options.isMobile
                    ? (M.open(e, "_blank", "directories=0,titlebar=0,toolbar=0,location=0,status=0,menubar=0").onload = function () {
                          (this.document.body.children[0].style.display = "none"), this.print();
                      })
                    : ((t = this._printIframe),
                      this._printIframe ||
                          ((t = this._printIframe = L.createElement("iframe")),
                ...
                M.jQuery.extend(M.jQuery.easing, {
                    ...
                    easeInElastic: function (e, t, o, i, n) {
                        ...
                        return 0 == t
                            ...
                            : 1 == (t /= n)
                            ? o + i
                            : ((a = a || 0.3 * n), (s = r < Math.abs(i) ? ((r = i), a / 4) : (a / (2 * Math.PI)) * Math.asin(i / r)), -(r * Math.pow(2, 10 * --t) * Math.sin(((t * n - s) * (2 * Math.PI)) / a)) + o);
                    },
                    easeOutElastic: function (e, t, o, i, n) {
                        ...
                        return 0 == t
                            ...
                            : 1 == (t /= n)
                            ? o + i
                            : ((a = a || 0.3 * n), (s = r < Math.abs(i) ? ((r = i), a / 4) : (a / (2 * Math.PI)) * Math.asin(i / r)), r * Math.pow(2, -10 * t) * Math.sin(((t * n - s) * (2 * Math.PI)) / a) + i + o);
                    },
                    easeInOutElastic: function (e, t, o, i, n) {
                        ...
                        return 0 == t
                            ...
                            ? o + i
                            : ((a = a || n * (0.3 * 1.5)),
                              (s = r < Math.abs(i) ? ((r = i), a / 4) : (a / (2 * Math.PI)) * Math.asin(i / r)),
                              t < 1 ? r * Math.pow(2, 10 * --t) * Math.sin(((t * n - s) * (2 * Math.PI)) / a) * -0.5 + o : r * Math.pow(2, -10 * --t) * Math.sin(((t * n - s) * (2 * Math.PI)) / a) * 0.5 + i + o);
                    },
                    ...
                    easeInOutBounce: function (e, t, o, i, n) {
                        return t < n / 2 ? 0.5 * y.easing.easeInBounce(e, 2 * t, 0, i, n) + o : 0.5 * y.easing.easeOutBounce(e, 2 * t - n, 0, i, n) + 0.5 * i + o;
                    },
                });
            },
        }),
        ...
        (FLIPBOOK.Thumbnails = function (o) {
            ...
            (this.main = o),
                ...
                (this.wrapper = e),
                (this.active = null),
                y(o).bind("pagechange", function () {
                    a.thumbsWrapper.css("top", a.bookmark.height() + 50 + "px");
                }),
                (this.thumbHolder = y(L.createElement("div")).addClass("flipbook-thumbHolder flipbook-side-menu skin-color-bg").appendTo(e).css(this.options.sideMenuPosition, "0").hide()),
                (this.thumbsWrapper = y(L.createElement("div")).appendTo(this.thumbHolder).addClass("flipbook-thumbsWrapper")),
                (this.thumbsScroller = y(L.createElement("div")).appendTo(this.thumbsWrapper).addClass("flipbook-thumbsScroller")),
                o.createMenuHeader(this.thumbHolder, o.strings.thumbnails, o.toggleThumbs),
                (this.bookmark = y("<div>").addClass("flipbook-font").appendTo(this.thumbHolder).hide());
            y('<a><div class="c-p skin-color flipbook-btn">' + i.strings.bookmarkCurrentPage + "</div></a>")
                .appendTo(this.bookmark)
                .bind("touchend click", function (e) {
                    o.bookmarkPage(o.cPage[0], this), e.preventDefault(), e.stopPropagation();
                }),
                y('<a><div class="c-l-p skin-color flipbook-btn">' + i.strings.bookmarkLeftPage + "</div></a>")
                    .appendTo(this.bookmark)
                    .bind("touchend click", function (e) {
                        o.bookmarkPage(o.cPage[0], this), e.preventDefault(), e.stopPropagation();
                    }),
                y('<a><div class="c-r-p skin-color flipbook-btn">' + i.strings.bookmarkRightPage + "</div></a>")
                    .appendTo(this.bookmark)
                    .bind("touchend click", function (e) {
                        o.bookmarkPage(o.cPage[1], this), e.preventDefault(), e.stopPropagation();
                    });
            (this.search = y("<div>").addClass("flipbook-search").appendTo(this.thumbHolder).hide()),
                (this.$searchBar = y(
                    ...
                    if ("" != i) {
                        ...
                        if ((a.hideAllThumbs(), (a.pagesFound = 0), a.$findInfo.hide(), o.unmark(), (o.searchingString = i), e))
                            for (var t = 0; t < e.pdfInfo.numPages; t++)
                                e.findInPage(i, t, function (e, t, o) {
                                ...
                                n.doublePage && (s *= 2),
                                    o.loadPageHTML(s, function (e, t) {
                                        0 < e.innerText.toUpperCase().search(o.searchingString.toUpperCase()) &&
                                            (n.doublePage && (t /= 2), a.showThumb(t), a.pagesFound++, a.$findInfo.show().text(a.pagesFound + " " + n.strings.pagesFoundContaining + ' "' + i + '"'), a.main.mark(i));
                                    });
                            }
                    }
                })),
            ...
            var t = i.pages,
                n = [];
            if (i.doublePage) for (var s = 0; s < t.length; s++) (0 != s && s % 2 == 0) || n.push(t[s]);
            else n = t;
                    ...
                    u
                        ...
                        c.bind("touchend click", function (e) {
                            ...
                            e.stopPropagation(),
                                e.preventDefault(),
                                a.thumbScroll.moved ||
                                    ((t = Number(y(this).attr("page-title"))),
                                    i.rightToLeft && (t = i.pages.length - t + 1),
                                    setTimeout(function () {
                                        o.goToPage(t);
                                    }, 200),
                                    "search" != a.active && i.thumbsCloseOnClick && o.toggleThumbs(!1));
                        });
                }
            }
        ...
        (FLIPBOOK.Lightbox = function (e, t, o) {
            ...
            y(e.elem).find("img");
            (i.overlay = y(L.createElement("div"))
                ...
                i.options.lightboxCloseOnClick &&
                    y("body").bind("tap click", function (e) {
                        var t = y(e.target);
                ...
                o.lightboxBackgroundColor && i.overlay.css("background", o.lightboxBackgroundColor),
                o.lightboxBackgroundPattern && i.overlay.css("background", "url(" + o.lightboxBackgroundPattern + ") repeat"),
                o.lightboxBackgroundImage && (i.overlay.css("background", "url(" + o.lightboxBackgroundImage + ") no-repeat"), i.overlay.css("background-size", "cover"), i.overlay.css("background-position", "center center")),
                y(L).keyup(function (e) {
                    27 == e.keyCode && i.closeLightbox();
                }),
                (i.wrapper = y(L.createElement("div")).css("height", "auto").appendTo(i.overlay)),
        ...
        (FLIPBOOK.Lightbox.prototype = {
            openLightbox: function () {
                FLIPBOOK.lightboxOpened ||
                    ...
                    y("body").addClass("flipbook-overflow-hidden"),
                    y("html").addClass("flipbook-overflow-hidden"),
                    y(M).trigger("r3d-lightboxopen"),
                    this.options.deeplinkingEnabled || M.history.pushState(null, "", M.location.href),
            ...
            closeLightbox: function (e) {
                (FLIPBOOK.lightboxOpened = !1),
                    ...
                    y("body").removeClass("flipbook-overflow-hidden"),
                    y("html").removeClass("flipbook-overflow-hidden"),
                    y(M).trigger("r3d-lightboxclose"),
                    y(this.context.fullscreenElement).removeClass("flipbook-browser-fullscreen"),
    ...
    (function (e) {
        ...
        function i(e, f) {
            function t(e) {
                if (!(!0 === G.data(Fe + "_intouch") || 0 < re(e.target).closest(f.excludedElements, G).length)) {
                    ...
                    if (!t.pointerType || "mouse" != t.pointerType || 0 != f.fallbackToMouseEvents) {
                        ...
                        return (
                            (Y = Oe),
                            i ? (X = i.length) : !1 !== f.preventDefaultEvents && e.preventDefault(),
                            (Z = j = N = null),
                            ($ = 1),
                            (q = U = V = W = R = 0),
                            ((s = {})[le] = L(le)),
                            ...
                            B(),
                            T(0, n),
                            !i || X === f.fingers || f.fingers === Be || k() ? ((ee = z()), 2 == X && (T(1, i[1]), (V = U = I(J[0].start, J[1].start))), (f.swipeStatus || f.pinchStatus) && (o = m(t, Y))) : (o = !1),
                            !1 === o
                                ? (m(t, (Y = Me)), o)
                                : (f.hold &&
                                      (ae = setTimeout(
            ...
            function o(e) {
                ...
                Y === ye ||
                    Y === Me ||
                    x() ||
                    ((i = y((o = g.touches) ? o[0] : g)),
                    (te = z()),
                    o && (X = o.length),
                    f.hold && clearTimeout(ae),
                    (Y = Te),
                    2 == X && (0 == V ? (T(1, o[1]), (V = U = I(J[0].start, J[1].start))) : (y(o[1]), (U = I(J[0].end, J[1].end)), J[0].end, J[1].end, (Z = $ < 1 ? ue : ce)), ($ = ((U / V) * 1).toFixed(2)), (q = Math.abs(V - U))),
                    X === f.fingers || f.fingers === Be || !o || k()
                        ? ((N = F(i.start, i.end)),
                          (function (e, t) {
                          ...
                          (c = i.start),
                          (u = i.end),
                          (R = Math.round(Math.sqrt(Math.pow(u.x - c.x, 2) + Math.pow(u.y - c.y, 2)))),
                          (W = C()),
                          (p = R),
                          (h = N) != ge && ((p = Math.max(p, M(h))), (Q[h].distance = p)),
                          (t = m(g, Y)),
                          (f.triggerOnTouchEnd && !f.triggerOnTouchLeave) ||
                              ((n = !0),
                              f.triggerOnTouchLeave &&
                                  ((s = { left: (d = (l = re((l = this))).offset()).left, right: d.left + l.outerWidth(), top: d.top, bottom: d.top + l.outerHeight() }),
                                  (a = i.end),
                                  (r = s),
                                  (n = a.x > r.left && a.x < r.right && a.y > r.top && a.y < r.bottom)),
                              !f.triggerOnTouchEnd && n ? (Y = b(Te)) : f.triggerOnTouchLeave && !n && (Y = b(ye)),
                              (Y != Me && Y != ye) || m(g, Y)))
                        : m(g, (Y = Me)),
                    !1 === t && m(g, (Y = Me)));
            }
            function i(e) {
                ...
                return (
                    ...
                    d() || !l()
                        ...
                        ? (!1 !== f.preventDefaultEvents && !1 !== e.cancelable && e.preventDefault(), m(o, (Y = ye)))
            ...
            function m(e, t) {
                ...
                return (
                    ...
                    S() && P() && !1 !== o ? (o = r(e, t, ve)) : W > f.longTapThreshold && R < xe && f.longTap && !1 !== o ? (o = r(e, t, we)) : (1 !== X && Le) || !(isNaN(R) || R < f.threshold) || !w() || !1 === o || (o = r(e, t, ke)),
                    t === Me && n(),
                    t === ye && ((i && i.length) || n()),
                    o
                );
                    ...
                    o == ke
                        ? (t !== Me && t !== ye) ||
                          ...
                          P() && !S()
                              ...
                              : ((ne = null), G.trigger("tap", [e.target]), f.tap && (i = f.tap.call(G, e, e.target))))
                        : o == ve
                        ? (t !== Me && t !== ye) || (clearTimeout(se), clearTimeout(ae), (ne = null), G.trigger("doubletap", [e.target]), f.doubleTap && (i = f.doubleTap.call(G, e, e.target)))
                        : o == we && ((t !== Me && t !== ye) || (clearTimeout(se), (ne = null), G.trigger("longtap", [e.target]), f.longTap && (i = f.longTap.call(G, e, e.target)))),
                    i
                );
            }
            function l() {
        ...
        (re.fn.swipe = function (e) {
            ...
            (re.fn.swipe.phases = { PHASE_START: Oe, PHASE_MOVE: Te, PHASE_END: ye, PHASE_CANCEL: Me }),
            ...
            (t.prototype.setup_instance = function (e, t) {
                ...
                for (
                    this.add_class(h, "sharer-" + t),
                        ...
                        i = h.getElementsByClassName("social")[0],
                        r = h.getElementsByTagName("li"),
