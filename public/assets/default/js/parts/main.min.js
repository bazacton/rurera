...
if (jQuery(".filter-mobile-btn").length > 0) {
  $('.filter-mobile-btn').on('click', function(e) {
    $('.filters-list .analytics-type, .filters-list .tests-list, .panel-content .inline-filters').toggleClass("open");
    e.preventDefault();
  });
}
...
$(document).on('click', '.process-payment', function (e) {
    rurera_loader($('.googlepay-gateway-fields'), 'div');
    ...
    $.ajax({
        ...
        success: function (return_data) {
            rurera_remove_loader($('.googlepay-gateway-fields'), 'div');
