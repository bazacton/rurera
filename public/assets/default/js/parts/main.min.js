...
$('.lms-chapter-ul-outer ul').each(function(){
  var LiN = $(this).find('li').length;
  if( LiN > 6){    
    $('li', this).eq(4).nextAll().hide().addClass('toggleable');   
  }  
});
$('.lms-chapter-ul-outer').append('<a href="#" class="more">More...</a>'); 
$('.lms-chapter-ul-outer').on('click','.more', function(){
    ...
    $(function() {
      ...
      if(jQuery('.testimonials-swiper.swiper-container').length > 0){
        const swiper = new Swiper(".testimonials-swiper.swiper-container", {
            ...
            autoplay: { delay: 5e3, disableOnInteraction: !1 },
            pagination: { el: ".swiper-pagination", clickable: !0 },
            breakpoints: { 991: { slidesPerView: 3 }, 660: { slidesPerView: 1 } },
        });
      }
