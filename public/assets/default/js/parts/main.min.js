...
$(document).on('click', '.editor-field-inputs.empty-field', function (e) {
	if( $('.rurera-selectable-options li.active').length > 0){
		var field_value = $('.rurera-selectable-options li.active').html();
...
$(window).on("load", function() {
    var blurredImageDiv = document.querySelectorAll(".lazyload-img").forEach();
    var img = blurredImageDiv.querySelectorAll("img").forEach();
    function loaded() {
